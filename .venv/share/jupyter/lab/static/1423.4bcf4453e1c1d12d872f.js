  ...
  [1423, 5606],
  {
    75128: (t, e, s) => {
      ...
      class M {
        ...
        setSelected(t, e) {
          return t == this.selected || t >= this.options.length ? this : new M(this.options, U(e, t), this.tooltip, this.timestamp, t, this.disabled);
        }
        static build(t, e, s, i, n, o) {
          ...
          return new M(
            r,
            U(s, l),
            { pos: t.reduce((t, e) => (e.hasResult() ? Math.min(t, e.from) : t), 1e8), create: Y, above: n.aboveCursor },
      ...
      class z {
        ...
        update(t) {
          ...
          if (t.selection || n.some((e) => e.hasResult() && t.changes.touchesRange(e.from, e.to)) || !F(n, this.active) || r)
            o = M.build(n, e, this.id, o, s, r);
          else if (o && o.disabled && !n.some((t) => t.isPending)) o = null;
          if (!o && n.every((t) => !t.isPending) && n.some((t) => t.hasResult())) n = n.map((t) => (t.hasResult() ? new q(t.source, 0) : t));
      ...
      function V(t, e) {
        ...
        return s && e.activateOnTyping ? 4 | 1 : s ? 1 : t.isUserEvent("delete.backward") ? 2 : t.selection ? 8 : t.docChanged ? 16 : 0;
      }
      class q {
      ...
      class H extends q {
        ...
        updateFor(t, e) {
          ...
          let r = g(t.state);
          if (r > o || !i || (e & 2 && (g(t.startState) == this.from || r < this.limit))) return new q(this.source, e & 4 ? 1 : 0);
          ...
          if (i.update && (i = i.update(i, n, o, new h(t.state, r, false))))
            return new H(this.source, this.explicit, l, i, i.from, (s = i.to) !== null && s !== void 0 ? s : g(t.state));
        ...
        map(t) {
          ...
          return new H(this.source, this.explicit, t.mapPos(this.limit), this.result, t.mapPos(this.from), t.mapPos(this.to, 1));
        }
        touches(t) {
        ...
        class {
          ...
          update(t) {
            ...
            for (let l = 0; l < this.running.length; l++) {
              ...
              if (i || (e.context.abortOnDocChange && t.docChanged) || (e.updates.length + t.transactions.length > it && Date.now() - e.time > nt)) {
            ...
            this.debounceUpdate = e.active.some((t) => t.isPending && !this.running.some((e) => e.active.source == t.source))
          ...
          accept() {
            ...
            for (let n = 0; n < this.running.length; n++) {
              ...
              if (o.done) {
                ...
                let r = new H(o.active.source, o.active.explicit, n, o.done, o.done.from, (t = o.done.to) !== null && t !== void 0 ? t : i);
      ...
      const lt = i.Prec.highest(
        o.EditorView.domEventHandlers({
          keydown(t, e) {
            ...
            if (!s || !s.open || s.open.disabled || s.open.selected < 0 || t.key.length > 1 || (t.ctrlKey && !(rt && t.altKey)) || t.metaKey)
              return false;
      ...
      function vt(t) {
        return ({ state: e, dispatch: s }) => {
          ...
          s(e.update({ selection: bt(i.ranges, n), effects: mt.of(o ? null : new dt(i.ranges, n)), scrollIntoView: true }));
          return true;
        };
      }
      ...
      function se(t, e, s, n) {
        ...
        let r = null,
          l = t.changeByRange((n) => {
            ...
            if (a == e) {
              if (ie(t, l)) {
                return { changes: { insert: e + e, from: l }, effects: $t.of(l + e.length), range: i.EditorSelection.cursor(l + e.length) };
              } else if (Yt(t, l)) {
            ...
            } else if (s && t.sliceDoc(l - 2 * e.length, l) == e + e && (h = oe(t, l - 2 * e.length, o)) > -1 && ie(t, h)) {
              return { changes: { insert: e + e + e + e, from: l }, effects: $t.of(l + e.length), range: i.EditorSelection.cursor(l + e.length) };
      ...
      function he(t) {
        ...
        return e && e.active.some((t) => t.isPending) ? "pending" : e && e.active.some((t) => t.state != 0) ? "active" : null;
      }
