...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [9296],
  {
    49296: (t, e, i) => {
      ...
      let j = typeof navigator != "undefined" ? navigator : { userAgent: "", vendor: "", platform: "" };
      let $ = typeof document != "undefined" ? document : { documentElement: { style: {} } };
      ...
      const ot = st && (/Mobile\/\w+/.test(j.userAgent) || j.maxTouchPoints > 2);
      var nt = {
        ...
        gecko: tt,
        gecko_version: tt ? +(/Firefox\/(\d+)/.exec(j.userAgent) || [0, 0])[1] : 0,
        chrome: !!et,
        ...
        webkit: it,
        safari: st,
        webkit_version: it ? +(/\bAppleWebKit\/(\d+)/.exec(j.userAgent) || [0, 0])[1] : 0,
        tabSize: $.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
      };
      const rt = 256;
      class lt extends K {
        constructor(t) {
        ...
        merge(t, e, i) {
          if (this.flags & 8 || (i && (!(i instanceof lt) || this.length - (e - t) + i.length > rt || i.flags & 8))) return false;
      ...
      class at extends K {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof at && i.mark.eq(this.mark)) || (t && o <= 0) || (e < this.length && n <= 0))) return false;
      ...
      function ht(t, e, i) {
        ...
        if (nt.safari && !r && a.width == 0) a = Array.prototype.find.call(l, (t) => t.width) || a;
      ...
      class ct extends K {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof ct) || !this.widget.compare(i.widget) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) return false;
        ...
        domAtPos(t) {
          return (this.length ? t == 0 : this.side > 0) ? I.before(this.dom) : I.after(this.dom, t == this.length);
        }
        domBoundsAround() {
          return null;
        }
      ...
      function ut(t, e, i) {
        let s,
          { children: o } = t;
        if (i > 0 && e instanceof at && o.length && (s = o[o.length - 1]) instanceof at && s.mark.eq(e.mark)) {
          ...
          for (let a = 0, h = 0; a < t.children.length && h <= e; a++) {
            ...
            if (f >= e) {
              if (c.children.length) {
                l(c, e - h);
              } else if ((!n || (n.isHidden && (i > 0 || mt(n, c)))) && (f > e || (h == f && c.getSide() > 0))) {
                n = c;
                r = e - h;
      ...
      class At extends Ct {
        ...
        eq(t) {
          return t instanceof At && this.spec.class == t.spec.class && bt(this.spec.attributes, t.spec.attributes);
        }
        range(t, e = t) {
      ...
      class Dt extends Ct {
        ...
        eq(t) {
          return t instanceof Dt && Tt(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
        }
        range(t, e = t) {
      ...
      class Rt extends K {
        ...
        become(t) {
          return t instanceof Rt && this.children.length == 0 && t.children.length == 0 && bt(this.attrs, t.attrs) && this.breakAfter == t.breakAfter;
        }
        covers() {
          return true;
        }
      ...
      class Bt extends K {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof Bt) || !this.widget.compare(i.widget) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) return false;
          this.length = t + (i ? i.length : 0) + (this.length - e);
          return true;
        }
        domAtPos(t) {
          return t == 0 ? I.before(this.dom) : I.after(this.dom, t == this.length);
        }
        split(t) {
          let e = this.length - t;
          this.length = t;
        ...
        become(t) {
          if (t instanceof Bt && t.widget.constructor == this.widget.constructor) {
        ...
        coordsAt(t, e) {
          ...
          return C(this.dom.getBoundingClientRect(), this.length ? t == 0 : e <= 0);
        }
        destroy() {
          super.destroy();
          if (this.dom) this.widget.destroy(this.dom);
      ...
      class Pt {
        ...
        finish(t) {
          ...
          if (!this.posCovered() && !(t && this.content.length && this.content[this.content.length - 1] instanceof Bt)) this.getLine();
        }
        buildText(t, e, i) {
          while (t > 0) {
            ...
            this.getLine().append(Ht(new lt(this.text.slice(this.textOff, this.textOff + s)), e), i);
            this.atCursorPos = true;
            this.textOff += s;
            t -= s;
            i = 0;
      ...
      function jt(t, e) {
        ...
        for (let i = 0; i < t.length; i++) {
          let s = t[i],
            o = e[i];
          if (s.from != o.from || s.to != o.to || s.direction != o.direction || !jt(s.inner, o.inner)) return false;
        }
        return true;
      }
      const $t = [];
        ...
        for (let n = 0; n <= s.length; n++) {
          ...
          for (let t = r, e = a, s = a; t < l; t++) {
            ...
            if (o == 128) {
              ...
              let o = t + 1;
              while (o < l && $t[o] == 64) o++;
              let n = (t && e == 8) || (o < i && $t[o] == 8) ? (s == 1 ? 1 : 8) : 256;
      ...
      function oe(t, e, i, o, n) {
        var r;
        let l = o.head - t.from;
        let a = Gt.find(e, l, (r = o.bidiLevel) !== null && r !== void 0 ? r : -1, o.assoc);
        let h = e[a],
          c = h.side(n, i);
        if (l == c) {
          let t = (a += n ? 1 : -1);
      ...
      class ve {
        ...
        clip(t) {
          return this.range.to <= t.doc.length
            ? this
            : new ve(s.EditorSelection.cursor(t.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
        }
      }
      ...
      class Ve {
        ...
        join(t) {
          return new Ve(Math.min(this.fromA, t.fromA), Math.max(this.toA, t.toA), Math.min(this.fromB, t.fromB), Math.max(this.toB, t.toB));
        }
        addToSet(t) {
          let e = t.length,
            i = this;
      ...
      class Fe {
        constructor(t, e, i) {
          ...
          let o = [];
          this.changes.iterChangedRanges((t, e, i, s) => o.push(new Ve(t, e, i, s)));
      ...
      class We extends K {
        ...
        update(t) {
          ...
          if (this.view.inputState.composing >= 0 && !this.view.observer.editContext) {
            ...
            else if (!Ge(t.changes, this.hasComposition) && !t.selectionSet) s = t.state.selection.main.head;
          }
          ...
          if (this.hasComposition) {
            ...
            i = new Ve(e, s, t.changes.mapPos(e, -1), t.changes.mapPos(s, 1)).addToSet(i.slice());
          }
          this.hasComposition = o ? { from: o.range.fromB, to: o.range.toB } : null;
          if ((nt.ie || nt.chrome) && !o && t && t.state.doc.lines != t.startState.doc.lines) this.forceSelection = true;
        ...
        updateInner(t, e, i) {
          ...
          s.ignore(() => {
            ...
            let t = nt.chrome || nt.ios ? { node: s.selectionRange.focusNode, written: false } : undefined;
          ...
          if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
            for (let n of this.children) if (n instanceof Bt && n.widget instanceof Lt) o.push(n.dom);
          s.updateGaps(o);
        }
        updateChildren(t, e, i) {
          ...
          for (let n = s.length - 1; ; n--) {
            ...
            if (i && i.range.fromB < a && i.range.toB > l) {
              let t = Pt.build(this.view.state.doc, l, i.range.fromB, this.decorations, this.dynamicDecorationMap);
              let e = Pt.build(this.view.state.doc, i.range.toB, a, this.decorations, this.dynamicDecorationMap);
              c = t.breakAtStart;
              f = t.openStart;
              d = e.openEnd;
              ...
              ({
                ...
                openStart: f,
                openEnd: d,
              } = Pt.build(this.view.state.doc, l, a, this.decorations, this.dynamicDecorationMap));
            }
        ...
        updateSelection(t = false, e = false) {
          ...
          if (
            n ||
            !h.focusNode ||
            ((!b(l.node, l.offset, h.anchorNode, h.anchorOffset) || !b(a.node, a.offset, h.focusNode, h.focusOffset)) &&
              !this.suppressWidgetCursorChange(h, r))
          ) {
            this.view.observer.ignore(() => {
              if (nt.android && nt.chrome && this.dom.contains(h.focusNode) && Xe(h.focusNode, this.dom)) {
                this.dom.blur();
          ...
          this.impreciseAnchor = l.precise ? null : new I(h.anchorNode, h.anchorOffset);
          this.impreciseHead = a.precise ? null : new I(h.focusNode, h.focusOffset);
        }
        ...
        coordsAt(t, e) {
          ...
          for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
            let r = this.children[n],
              ...
              a = l - r.length;
            if (l < t) break;
            if (a <= t && (a < t || r.covers(-1)) && (l > t || r.covers(1)) && (!i || (r instanceof Rt && !(i instanceof Rt && e >= 0)))) {
              i = r;
              s = a;
            } else if (i && a == t && l == t && r instanceof Bt && Math.abs(e) < 2) {
        ...
        computeBlockGapDeco() {
          ...
          for (let i = 0, s = 0; ; s++) {
            ...
            if (n > i) {
              ...
              t.push(Ct.replace({ widget: new Lt(s), block: true, inclusive: true, isBlockGap: true }).range(i, n));
            }
            if (!o) break;
            i = o.to + 1;
          }
        ...
        updateDeco() {
          ...
          this.decorations = [this.editContextFormatting, ...e, this.computeBlockGapDeco(), this.view.viewState.lineGapDeco];
      ...
      function qe(t, e, i) {
        ...
        for (let f = o.parentNode; ; f = f.parentNode) {
          ...
          else if (e instanceof Rt || (f.nodeName == "DIV" && f.parentNode == t.contentDOM)) return { range: h, text: o, marks: c, line: f };
          else if (f != t.contentDOM) c.push({ node: f, deco: new kt({ inclusive: true, attributes: St(f), tagName: f.tagName.toLowerCase() }) });
          else return null;
        }
      }
      function Ke(t, e) {
      ...
      function ti(t, e, i) {
        ...
        for (let p = t.firstChild; p; p = p.nextSibling) {
          ...
          for (let d = 0; d < t.length; d++) {
            ...
            let g = $e(e, u),
              m = Ue(i, u);
            if (g == 0 && m == 0) return p.nodeType == 3 ? ei(p, e, i) : ti(p, e, i);
            if (!s || r > m || (r == m && n > g)) {
              s = p;
              o = u;
              n = g;
      ...
      function ii(t, e, i, s = -1) {
        ...
        f = l + d;
        let u = a.from;
        if (u < t.viewport.from) return t.viewport.from == 0 ? 0 : i ? null : si(t, r, a, c, f);
        if (u > t.viewport.to) return t.viewport.to == t.state.doc.length ? t.state.doc.length : i ? null : si(t, r, a, c, f);
        ...
        if (m && ((o = t.docView.nearest(m)) === null || o === void 0 ? void 0 : o.isEditable) != false) {
          if (p.caretPositionFromPoint) {
            ...
            if (e) {
              ...
              if (!t.contentDOM.contains(w) || (nt.safari && oi(w, v, c)) || (nt.chrome && ni(w, v, c))) w = undefined;
            }
          }
      ...
      function ri(t, e, i) {
        ...
        if (Array.isArray(s.type)) {
          ...
          for (let o of s.type) {
            ...
            if (!t || (o.type == Mt.Text && (t.type != o.type || (i < 0 ? o.from < e : o.to > e)))) t = o;
          }
          return t || s;
        }
        return s;
      ...
      function li(t, e, i, o) {
        ...
        if (r) {
          ...
          let l = t.posAtCoords({ x: i == (o == Vt.LTR) ? e.right - 1 : e.left + 1, y: (r.top + r.bottom) / 2 });
      ...
      class pi {
        ...
        readRange(t, e) {
          ...
          for (let s = t; ; ) {
            ...
            let n = K.get(s),
              r = K.get(o);
            if (n && r ? n.breakAfter : (n ? n.breakAfter : S(s)) || (S(o) && (s.nodeName != "BR" || s.cmIgnore) && this.text.length > t))
              this.lineBreak();
            s = o;
          }
        ...
        findPointInside(t, e) {
          for (let i of this.points)
            if (t.nodeType == 3 ? i.node == t : t.contains(i.node)) i.pos = this.text.length + (gi(t, i.node, i.offset) ? e : 0);
        }
      }
      function gi(t, e, i) {
        for (;;) {
      ...
      class wi {
        constructor(t, e, i, o) {
          ...
          if (t.state.readOnly && e > -1) {
            ...
            let l = t.viewport;
            if ((nt.ios || nt.chrome) && t.state.selection.main.empty && i != o && (l.from > 0 || l.to < t.state.doc.length)) {
              let e = Math.min(i, o),
                s = Math.max(i, o);
              let n = l.from - e,
                r = l.to - s;
      ...
      function vi(t, e) {
        ...
        if (e.bounds) {
          ...
          if (c) {
            if (nt.chrome && r == 13 && c.toB == c.from + 2 && e.text.slice(c.from, c.toB) == ui + ui) c.toB--;
            i = { from: o + c.from, to: o + c.toA, insert: s.Text.of(e.text.slice(c.from, c.toB).split(ui)) };
          }
        ...
        } else if (nt.chrome && i && i.from == i.to && i.from == n.head && i.insert.toString() == "\n " && t.lineWrapping) {
      ...
      function bi(t, e, i, s = -1) {
        ...
        if (
          ...
          ((e.to == o.to &&
            ...
            (((e.from == o.from - 1 && e.to == o.to && e.insert.length == 0) || (s == 8 && e.insert.length < e.to - e.from && e.to > o.head)) &&
              P(t.contentDOM, "Backspace", 8)) ||
            (e.from == o.from && e.to == o.to + 1 && e.insert.length == 0 && P(t.contentDOM, "Delete", 46)))
        )
          return true;
        ...
        let r;
        let l = () => r || (r = yi(t, e, i));
        if (!t.state.facet(fe).some((i) => i(t, e.from, e.to, n, l))) t.dispatch(l());
        return true;
      }
      function yi(t, e, i) {
        let o,
      ...
      class Ci {
        ...
        keydown(t) {
          ...
          if (t.keyCode == 9 && this.tabFocusMode > -1 && (!this.tabFocusMode || Date.now() <= this.tabFocusMode)) return true;
          if (this.tabFocusMode > 0 && t.keyCode != 27 && Ti.indexOf(t.keyCode) < 0) this.tabFocusMode = -1;
          if (nt.android && nt.chrome && !t.synthetic && (t.keyCode == 13 || t.keyCode == 8)) {
          ...
          if (
            ...
            !t.altKey &&
            !t.metaKey &&
            (((e = Di.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) || (Oi.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
          ) {
        ...
        flushIOSKey(t) {
          ...
          this.pendingIOSKey = undefined;
          return P(this.view.contentDOM, e.key, e.keyCode, e instanceof KeyboardEvent ? e : undefined);
        }
        ignoreDuringComposition(t) {
          if (!/^key/.test(t.type)) return false;
          if (this.composing > 0) return true;
          if (nt.safari && !nt.ios && this.compositionPendingKey && Date.now() - this.compositionEndedAt < 100) {
            this.compositionPendingKey = false;
            return true;
          }
          return false;
      ...
      class Li {
        constructor(t, e, i, o) {
          ...
          this.multiple = t.state.facet(s.EditorState.allowMultipleSelections) && Pi(t, e);
        ...
        move(t) {
          ...
          if (this.dragging || (this.dragging == null && Bi(this.startEvent, t) < 10)) return;
      ...
      const zi = (nt.ie && nt.ie_version < 15) || (nt.ios && nt.webkit_version < 604);
      function Ii(t) {
      ...
      function Ki(t, e) {
        ...
        let a = os != null && i.selection.ranges.every((t) => t.empty) && os == r.toString();
        if (a) {
          let t = -1;
          o = i.changeByRange((o) => {
      ...
      let _i = (t, e, i) => e >= i.top && e <= i.bottom && t >= i.left && t <= i.right;
      function Xi(t, e, i, s) {
      ...
      function Ji(t) {
        ...
        $i = t;
        Qi = Date.now();
        return (Ui = !e || (i > Date.now() - 400 && Math.abs(e.clientX - t.clientX) < 2 && Math.abs(e.clientY - t.clientY) < 2) ? (Ui + 1) % 3 : 1);
      }
      function Zi(t, e) {
        let i = Gi(t, e),
          o = Ji(e);
        ...
        return {
          ...
          get(e, r, l) {
            ...
            else if (l && o == 1 && n.ranges.length > 1 && (h = ts(n, a.pos))) return h;
      ...
      Fi.dragstart = (t, e) => {
        ...
        o.draggedContent = i;
        if (e.dataTransfer) {
          e.dataTransfer.setData("Text", qi(t.state, pe, t.state.sliceDoc(i.from, i.to)));
      ...
      Fi.drop = (t, e) => {
        ...
        if (i && i.length) {
          let s = Array(i.length),
            o = 0;
          let n = () => {
            if (++o == i.length) es(t, e, s.filter((t) => t != null).join(t.state.lineBreak), false);
          };
      ...
      function rs(t, e) {
        ...
        return i.length ? t.update({ effects: i, annotations: ns.of(true) }) : null;
      }
      function ls(t) {
        setTimeout(() => {
          let e = t.hasFocus;
      ...
      Fi.beforeinput = (t, e) => {
        ...
        let o;
        if (nt.chrome && nt.android && (o = Di.find((t) => t.inputType == e.inputType))) {
        ...
        if (nt.safari && e.inputType == "insertText" && t.inputState.composing >= 0) {
      ...
      class gs {
        ...
        join(t) {
          ...
          return new gs(this.from, this.length + t.length, this.top, this.height + t.height, e);
        }
      }
      var ms = (function (t) {
        t[(t["ByPos"] = 0)] = "ByPos";
      ...
      class Ss extends ys {
        ...
        replace(t, e, i) {
          let s = i[0];
          if (i.length == 1 && (s instanceof Ss || (s instanceof xs && s.flags & 4)) && Math.abs(this.length - s.length) < 10) {
        ...
        updateHeight(t, e = 0, i = false, s) {
          if (s && s.from <= e && s.more) this.setHeight(s.heights[s.index++]);
            ...
            this.setHeight(Math.max(this.widgetHeight, t.heightForLine(this.length - this.collapsed)) + this.breaks * t.lineHeight);
          this.outdated = false;
          return this;
        }
        toString() {
      ...
      class xs extends vs {
        ...
        lineAt(t, e, i, s, o) {
          ...
          return new gs(a.from, a.length, Math.max(s, Math.min(f, s + this.height - h)), h, 0);
        }
        forEachLine(t, e, i, s, o, n) {
          t = Math.max(t, o);
        ...
        updateHeight(t, e = 0, i = false, s) {
          ...
          if (s && s.from <= e + this.length && s.more) {
            ...
            let l = vs.of(i);
            if (r < 0 || Math.abs(l.height - this.height) >= ws || Math.abs(r - this.heightMetrics(t, e).perLine) >= ws) fs = true;
            return bs(this, l);
          } else if (i || this.outdated) {
      ...
      class Ms extends vs {
        ...
        balanced(t, e) {
          if (t.size > 2 * e.size || e.size > 2 * t.size) return vs.of(this.break ? [t, null, e] : [t, e]);
      ...
      function Cs(t, e) {
        let i, s;
        if (t[e] == null && (i = t[e - 1]) instanceof xs && (s = t[e + 1]) instanceof xs) t.splice(e - 1, 3, new xs(i.length + 1 + s.length));
      }
      const ks = 5;
      class As {
        constructor(t, e) {
      ...
      class Os {
        ...
        comparePoint(t, e, i, s) {
          if (t < e || (i && i.heightRelevant) || (s && s.heightRelevant)) Et(t, e, this.changes, 5);
        }
      }
      function Ts(t, e) {
      ...
      class Bs {
        ...
        draw(t, e) {
          return Ct.replace({ widget: new Ls(this.displaySize * (e ? t.scaleY : t.scaleX), e) }).range(this.from, this.to);
        }
      }
      class Ls extends xt {
        constructor(t, e) {
      ...
      class Ps {
        constructor(t) {
          ...
          let e = t.facet(Oe).some((t) => typeof t != "function" && t.class == "cm-lineWrapping");
          this.heightOracle = new us(e);
          this.stateDeco = t.facet(Te).filter((t) => typeof t != "function");
          this.heightMap = vs.empty().applyChanges(this.stateDeco, s.Text.empty, this.heightOracle.setDoc(t.doc), [new Ve(0, 0, 0, t.doc.length)]);
          for (let i = 0; i < 2; i++) {
          ...
          this.lineGapDeco = Ct.set(this.lineGaps.map((t) => t.draw(this, false)));
        ...
        updateScaler() {
          let t = this.scaler;
          this.scaler = this.heightMap.height <= 7e6 ? zs : new Is(this.heightOracle, this.heightMap, this.viewports);
        ...
        update(t, e = null) {
          ...
          this.stateDeco = this.state.facet(Te).filter((t) => typeof t != "function");
          let o = t.changedRanges;
          let n = Ve.extendWithRanges(o, Ds(i, this.stateDeco, t ? t.changes : s.ChangeSet.empty(this.state.doc.length)));
        ...
        measure(t) {
          ...
          if (a) {
            ...
            for (let i of this.viewports) {
              ...
              this.heightMap = (
                r ? vs.empty().applyChanges(this.stateDeco, s.Text.empty, this.heightOracle, [new Ve(0, 0, 0, t.state.doc.length)]) : this.heightMap
        ...
        getViewport(t, e) {
          ...
          let l = new Hs(s.lineAt(n - i * 1e3, ms.ByHeight, o, 0, 0).from, s.lineAt(r + (1 - i) * 1e3, ms.ByHeight, o, 0, 0).to);
          if (e) {
            let { head: t } = e.range;
            if (t < l.from || t > l.to) {
              ...
              l = new Hs(s.lineAt(r - 1e3 / 2, ms.ByHeight, o, 0, 0).from, s.lineAt(r + i + 1e3 / 2, ms.ByHeight, o, 0, 0).to);
            }
          }
          return l;
        }
        ...
        viewportIsAppropriate({ from: t, to: e }, i = 0) {
          ...
          let { top: s } = this.heightMap.lineAt(t, ms.ByPos, this.heightOracle, 0, 0);
          let { bottom: o } = this.heightMap.lineAt(e, ms.ByPos, this.heightOracle, 0, 0);
          let { visibleTop: n, visibleBottom: r } = this;
          return (
        ...
        mapLineGaps(t, e) {
          ...
          let i = [];
          for (let s of t) if (!e.touchesRange(s.from, s.to)) i.push(new Bs(e.mapPos(s.from), e.mapPos(s.to), s.size, s.displaySize));
          return i;
        }
        ensureLineGaps(t, e) {
        ...
        updateLineGaps(t) {
          if (!Bs.same(t, this.lineGaps)) {
            this.lineGaps = t;
            this.lineGapDeco = Ct.set(t.map((t) => t.draw(this, this.heightOracle.lineWrapping)));
          }
        }
        ...
        lineBlockAt(t) {
          return (
            ...
            qs(this.heightMap.lineAt(t, ms.ByPos, this.heightOracle, 0, 0), this.scaler)
          );
        }
        lineBlockAtHeight(t) {
          return (
            ...
            qs(this.heightMap.lineAt(this.scaler.fromDOM(t), ms.ByHeight, this.heightOracle, 0, 0), this.scaler)
          );
        }
        scrollAnchorAt(t) {
        ...
        elementAtHeight(t) {
          return qs(this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0), this.scaler);
        }
        get docHeight() {
      ...
      function qs(t, e) {
        ...
        let i = e.toDOM(t.top),
          s = e.toDOM(t.bottom);
        return new gs(t.from, t.length, i, s - i, Array.isArray(t._content) ? t._content.map((t) => qs(t, e)) : t._content);
      }
      ...
      class Zs {
        constructor(t) {
          ...
          if (window.EditContext && t.constructor.EDIT_CONTEXT !== false && !(nt.chrome && nt.chrome_version < 126)) {
            this.editContext = new so(t);
            if (t.state.facet(xe)) t.contentDOM.editContext = this.editContext.editContext;
          }
          if (Js)
            this.onCharData = (t) => {
        ...
        onSelectionChange(t) {
          ...
          if (i.state.facet(xe) ? i.root.activeElement != this.dom : !w(this.dom, s)) return;
        ...
        readSelectionRange() {
          ...
          let e = g(t.root);
          if (!e) return false;
          let i = (nt.safari && t.root.nodeType == 11 && t.root.activeElement == this.dom && io(this.view, e)) || e;
        ...
        start() {
          ...
          if (Js) this.dom.addEventListener("DOMCharacterDataModified", this.onCharData);
          this.active = true;
        }
        stop() {
          if (!this.active) return;
          ...
          if (Js) this.dom.removeEventListener("DOMCharacterDataModified", this.onCharData);
        }
        clear() {
          this.processRecords();
          this.queue.length = 0;
        ...
        flush(t = true) {
          ...
          if (this.view.state == i && (e.domChanged || (e.newSel && !e.newSel.main.eq(this.view.state.selection.main)))) this.view.update([]);
          return s;
        }
        readMutation(t) {
        ...
        update(t) {
          if (this.editContext) {
            ...
            if (t.startState.facet(xe) != t.state.facet(xe)) t.view.contentDOM.editContext = t.state.facet(xe) ? this.editContext.editContext : null;
          }
        }
        destroy() {
          var t, e, i;
      ...
      class so {
        constructor(t) {
          ...
          this.handlers.textupdate = (e) => {
            ...
            if (t.inputState.composing >= 0 && !this.composing) this.composing = { contextBase: e.updateRangeStart, editorBase: r, drifted: false };
            ...
            if ((nt.mac || nt.android) && a.from == n - 1 && /^\. ?$/.test(e.text) && t.contentDOM.getAttribute("autocorrect") == "off")
            ...
            if (!t.state.readOnly) {
              ...
              bi(t, a, s.EditorSelection.single(this.toEditorPos(e.selectionStart, i), this.toEditorPos(e.selectionEnd, i)));
            }
        ...
        setSelection(t) {
          ...
          if (this.editContext.selectionStart != i || this.editContext.selectionEnd != s) this.editContext.updateSelection(i, s);
        }
        rangeIsValid(t) {
          let { head: e } = t.selection.main;
      ...
      class oo {
        ...
        constructor(t = {}) {
          ...
          if (t.scrollTo && t.scrollTo.is(be)) this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state);
        ...
        update(t) {
          ...
          try {
            ...
            for (let e of t) {
              ...
              if (e.scrollIntoView) {
                ...
                f = new ve(t.empty ? t : s.EditorSelection.cursor(t.head, t.head > t.anchor ? -1 : 1));
              }
              for (let t of e.effects) if (t.is(be)) f = t.value.clip(this.state);
            }
          ...
          if (a || c)
            Promise.resolve().then(() => {
              ...
              if (c) {
                if (!vi(this, c) && h.force) P(this.contentDOM, h.key, h.keyCode);
              }
            });
        }
        setState(t) {
        ...
        get themeClasses() {
          return _s + " " + (this.state.facet(Ys) ? Gs : Xs) + " " + this.state.facet(Ks);
        }
        updateAttrs() {
          let t = ao(this, De, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses });
          let e = {
            spellcheck: "false",
            autocorrect: "off",
            autocapitalize: "off",
        ...
        mountStyles() {
          ...
          o.StyleModule.mount(this.root, this.styleModules.concat(Us).reverse(), t ? { nonce: t } : undefined);
        }
        readMeasured() {
        ...
        bidiSpans(t) {
          ...
          for (let o of this.bidiCache) {
            if (o.from == t.from && o.dir == e && (o.fresh || jt(o.isolates, (i = Le(this, t))))) return o.order;
          }
          if (!i) i = Le(this, t);
          let s = ee(t.text, e, i);
        ...
        get hasFocus() {
          ...
          return (
            (this.dom.ownerDocument.hasFocus() ||
              (nt.safari && ((t = this.inputState) === null || t === void 0 ? void 0 : t.lastContextMenu) > Date.now() - 3e4)) &&
        ...
        static scrollIntoView(t, e = {}) {
          return be.of(new ve(typeof t == "number" ? s.EditorSelection.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
        }
        scrollSnapshot() {
          let { scrollTop: t, scrollLeft: e } = this.scrollDOM;
          let i = this.viewState.scrollAnchorAt(t);
          return be.of(new ve(s.EditorSelection.cursor(i.from), "start", "start", i.top - t, e, true));
        }
        setTabFocusMode(t) {
        ...
        static update(t, e) {
          ...
          for (let o = Math.max(0, t.length - 10); o < t.length; o++) {
            ...
            if (n.dir == s && !e.touchesRange(n.from, n.to))
              i.push(new lo(e.mapPos(n.from, 1), e.mapPos(n.to, -1), n.dir, n.isolates, false, n.order));
          }
          return i;
        }
      }
      ...
      const ho = nt.mac ? "mac" : nt.windows ? "win" : nt.linux ? "linux" : "key";
      function co(t, e) {
        const i = t.split(/-(?!$)/);
        let s = i[i.length - 1];
        if (s == "Space") s = " ";
      ...
      function xo(t, e, i, o) {
        ...
        if (w) {
          if (m(w[c + fo(l, e, !h)])) {
            f = true;
          } else if (h && (e.altKey || e.metaKey || e.ctrlKey) && !(nt.windows && e.ctrlKey && e.altKey) && (v = n[e.keyCode]) && v != l) {
            if (m(w[c + fo(v, e, true)])) {
              f = true;
            } else if (e.shiftKey && (b = r[e.keyCode]) != l && b != v && m(w[c + fo(b, e, false)])) {
              f = true;
            }
      ...
      class Mo {
        ...
        static forRange(t, e, i) {
          if (i.empty) {
            ...
            if (!s) return [];
            let o = Co(t);
            return [new Mo(e, s.left - o.left, s.top - o.top, null, s.bottom - s.top)];
          } else {
            return Ao(t, e, i);
          }
        }
      ...
      function Co(t) {
        ...
        let i = t.textDirection == Vt.LTR ? e.left : e.right - t.scrollDOM.clientWidth * t.scaleX;
      ...
      function Ao(t, e, i) {
        ...
        if (g && m && g.from == m.from && g.to == m.to) {
          ...
          else if (e.bottom < s.top && t.elementAtHeight((e.bottom + s.top) / 2).type == Mt.Text) e.bottom = s.top = (e.bottom + s.top) / 2;
      ...
      class Oo {
        ...
        update(t) {
          if (t.startState.facet(To) != t.state.facet(To)) this.setOrder(t.state);
        ...
        draw(t) {
          if (t.length != this.drawn.length || t.some((t, e) => !Do(t, this.drawn[e]))) {
      ...
      const Vo = Eo({
        above: false,
        markers(t) {
          return t.state.selection.ranges.map((e) => (e.empty ? [] : Mo.forRange(t, "cm-selectionBackground", e))).reduce((t, e) => t.concat(e));
        },
        update(t, e) {
      ...
      const Fo = s.Prec.highest(
        oo.theme({
          ".cm-line": { "& ::selection, &::selection": { backgroundColor: "transparent !important" }, caretColor: "transparent !important" },
          ".cm-content": {
        ...
        class {
          ...
          update(t) {
            ...
            if (i == null) {
              ...
              if (t.startState.field(zo) != i || t.docChanged || t.geometryChanged) this.view.requestMeasure(this.measureReq);
            }
          }
          readPos() {
            let { view: t } = this;
          ...
          setDropPos(t) {
            if (this.view.state.field(zo) != t) this.view.dispatch({ effects: Wo.of(t) });
          }
        },
        {
          eventObservers: {
      ...
      class _o {
        ...
        createDeco(t) {
          let e = new s.RangeSetBuilder(),
            i = e.add.bind(e);
          for (let { from: s, to: o } of Yo(t, this.maxLength)) Ko(t.state.doc, this.regexp, s, o, (e, s) => this.addMatch(s, t, e, i));
          return e.finish();
        }
        updateDeco(t, e) {
          let i = 1e9,
          ...
          for (let o of t.visibleRanges) {
            ...
            if (r > n) {
              ...
              if (i == s) {
                ...
                Ko(t.state.doc, this.regexp, l, a, (e, i) => this.addMatch(i, t, e, f));
              }
      ...
      function Uo() {
        ...
        if ($o == null && typeof document != "undefined" && document.body) {
          ...
          $o = ((t = e.tabSize) !== null && t !== void 0 ? t : e.MozTabSize) != null;
        }
        return $o || false;
      }
      const Qo = s.Facet.define({
        combine(t) {
          let e = (0, s.combineConfig)(t, { render: null, specialChars: Go, addSpecialChars: null });
          if ((e.replaceTabs = !Uo())) e.specialChars = new RegExp("\t|" + e.specialChars.source, Xo);
          if (e.addSpecialChars) e.specialChars = new RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, Xo);
          return e;
        },
      });
      function Jo(t = {}) {
                ...
                return new _o({
                  ...
                  decoration: (e, i, o) => {
                    ...
                    if (r == 9) {
                      ...
                      return Ct.replace({ widget: new nn(((e - (r % e)) * this.view.defaultCharacterWidth) / this.view.scaleX) });
                    }
                    return this.decorationCache[r] || (this.decorationCache[r] = Ct.replace({ widget: new on(t, r) }));
                  },
      ...
      class on extends xt {
        ...
        toDOM(t) {
          let e = sn(this.code);
          let i = t.state.phrase("Control character") + " " + (jo[this.code] || "0x" + this.code.toString(16));
      ...
      function ln() {
        return [
          ...
          Oe.of((t) => {
            var e;
            return ((e = t.plugin(rn)) === null || e === void 0 ? void 0 : e.attrs) || null;
          }),
        ];
      }
      function an() {
      ...
      class fn extends xt {
        ...
        toDOM(t) {
          ...
          if (typeof this.content == "string") e.setAttribute("aria-label", "placeholder " + this.content);
      ...
      function dn(t) {
        return ke.fromClass(
          class {
            constructor(e) {
              this.view = e;
              this.placeholder = t ? Ct.set([Ct.widget({ widget: new fn(t), side: 1 }).range(0)]) : Ct.none;
            }
            get decorations() {
      ...
      function mn(t, e) {
        ...
        let o = t.state.doc.lineAt(i),
          n = i - o.from;
        let r = n > un ? -1 : n == o.length ? gn(t, e.clientX) : (0, s.countColumn)(o.text, t.state.tabSize, i - o.from);
      ...
      function Sn(t = {}) {
        ...
        return [
          ...
          oo.contentAttributes.of((t) => {
            var e;
            return ((e = t.plugin(s)) === null || e === void 0 ? void 0 : e.isDown) ? yn : null;
          }),
        ];
      }
      const xn = "-10000px";
      ...
      const An = s.Facet.define({
        combine: (t) => {
          var e, i, s;
          return {
            position: nt.ios ? "absolute" : ((e = t.find((t) => t.position)) === null || e === void 0 ? void 0 : e.position) || "fixed",
            parent: ((i = t.find((t) => t.parent)) === null || i === void 0 ? void 0 : i.parent) || null,
            tooltipSpace: ((s = t.find((t) => t.tooltipSpace)) === null || s === void 0 ? void 0 : s.tooltipSpace) || kn,
          };
        },
      });
        ...
        class {
          ...
          readMeasure() {
            ...
            let s = this.view.scrollDOM.getBoundingClientRect(),
              o = He(this.view);
            return {
              visible: { left: s.left + o.left, top: s.top + o.top, right: s.right - o.right, bottom: s.bottom - o.bottom },
          ...
          writeMeasure(t) {
            ...
            for (let l = 0; l < this.manager.tooltips.length; l++) {
              ...
              let g = d.right - d.left,
                m = (e = Dn.get(h)) !== null && e !== void 0 ? e : d.bottom - d.top;
              let w = h.offset || Rn,
              ...
              let b =
                d.width > s.right - s.left
                  ? v
                    ...
                    : s.right - d.width
                  : v
                    ? Math.max(s.left, Math.min(f.left - (u ? 14 : 0) + w.x, s.right - g))
                    : Math.min(Math.max(s.left, f.left - g + (u ? 14 : 0) - w.x), s.right - g);
              let y = this.above[l];
              if (!a.strictSide && (y ? f.top - m - p - w.y < s.top : f.bottom + m + p + w.y > s.bottom) && y == s.bottom - f.bottom > f.top - s.top)
                y = this.above[l] = !y;
          ...
          maybeMeasure() {
            if (this.manager.tooltips.length) {
              ...
              if (this.inView != this.view.inView) {
                ...
                if (!this.inView) for (let t of this.manager.tooltipViews) t.dom.style.top = xn;
              }
            }
          }
        },
      ...
      const Ln = s.Facet.define({ combine: (t) => t.reduce((t, e) => t.concat(e), []) });
      class Pn {
        static create(t) {
          return new Pn(t);
        }
      ...
      class Nn {
        ...
        get tooltip() {
          ...
          let e = t ? t.manager.tooltips.findIndex((t) => t.create == Pn.create) : -1;
        ...
        mousemove(t) {
          ...
          if ((s.length && o && !Fn(o.dom, t)) || this.pending) {
            ...
            if (o == n ? this.view.posAtCoords(this.lastMove) != o : !Wn(this.view, o, n, t.clientX, t.clientY)) {
      ...
      function Fn(t, e) {
        ...
        return e.clientX >= i - Vn && e.clientX <= s + Vn && e.clientY >= o - Vn && e.clientY <= n + Vn;
      }
      ...
      function zn(t, e = {}) {
        ...
        return { active: o, extension: [o, ke.define((s) => new Nn(s, t, o, i, e.hoverTime || 300)), Hn] };
      }
      function In(t, e) {
        let i = t.plugin(On);
        if (!i) return null;
      ...
      const lr = ke.fromClass(
        class {
          ...
          syncGutters(t) {
            ...
            let i = s.RangeSet.iter(this.view.state.facet(tr), this.view.viewport.from);
            let o = [];
            let n = this.gutters.map((t) => new cr(t, this.view.viewport, -this.view.documentPadding.top));
          ...
          updateGutters(t) {
            ...
            let o =
              ...
              t.heightChanged ||
              t.viewportChanged ||
              !s.RangeSet.eq(t.startState.facet(tr), t.state.facet(tr), t.view.viewport.from, t.view.viewport.to);
            if (e == i) {
        ...
        },
        {
          provide: (t) =>
            oo.scrollMargins.of((e) => {
              ...
              return e.textDirection == Vt.LTR ? { left: i.dom.offsetWidth * e.scaleX } : { right: i.dom.offsetWidth * e.scaleX };
            }),
        }
      );
      function ar(t) {
      ...
      const Or = kr(new _o({ regexp: /\t| /g, decoration: (t) => (t[0] == "\t" ? Ar : Dr), boundary: /\S/ }));
      function Tr() {
        return Or;
      }
      const Er = kr(new _o({ regexp: /\s+$/g, decoration: Ct.mark({ class: "cm-trailingSpace" }), boundary: /\S/ }));
      function Rr() {
        return Er;
      }
      const Br = {
