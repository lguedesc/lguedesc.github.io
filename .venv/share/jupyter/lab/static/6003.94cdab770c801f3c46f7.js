  ...
  [6003],
  {
    56003: (t, e, n) => {
      ...
      class w extends m {
        ...
        decompose(t, e, n, i) {
          let s = t <= 0 && e >= this.length ? this : new w(y(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
          if (i & 1) {
            let t = n.pop();
      ...
      class x extends m {
        ...
        scanIdentical(t, e) {
          ...
          let n = 0;
          let [i, s, r, l] = e > 0 ? [0, 0, this.children.length, t.children.length] : [this.children.length - 1, t.children.length - 1, -1, -1];
          for (; ; i += e, s += e) {
            if (i == r || s == l) return n;
        ...
        mapPos(t, e = -1, n = B.Simple) {
          ...
          for (let r = 0; r < this.sections.length; ) {
            ...
            if (h < 0) {
              ...
              if (n != B.Simple && o >= t && ((n == B.TrackDel && i < t && o > t) || (n == B.TrackBefore && i < t) || (n == B.TrackAfter && o > t)))
                return null;
        ...
        static of(t, e, n) {
          ...
          function o(t) {
            if (Array.isArray(t)) {
              ...
              if (l > o || l < 0 || o > e) throw new RangeError(`Invalid change range ${l} to ${o} (in doc of length ${e})`);
              ...
              if (o != null) {
                ...
                if (
                  this.dependencies.every((n) =>
                    n instanceof G ? e.facet(n) === t.facet(n) : n instanceof tt ? e.field(n, false) == t.field(n, false) : true
                  ) ||
      ...
      const it = { highest: nt(et.highest), high: nt(et.high), default: nt(et.default), low: nt(et.low), lowest: nt(et.lowest) };
      class st {
        constructor(t, e) {
          this.inner = t;
          this.prec = e;
      ...
      function Mt(t) {
        ...
        if (n !== true) {
          ...
          t = St.create(e, i, t.selection && t.selection.map(s), yt.mapEffects(t.effects, s), t.annotations, t.scrollIntoView);
        }
        let i = e.facet(pt);
      ...
      class Dt {
        ...
        replaceSelection(t) {
          ...
          return this.changeByRange((e) => ({ changes: { from: e.from, to: e.to, insert: t }, range: V.cursor(e.from + t.length) }));
        }
        changeByRange(t) {
        ...
        static fromJSON(t, e = {}, n) {
          ...
          return Dt.create({ doc: t.doc, selection: V.fromJSON(t.selection), extensions: e.extensions ? i.concat([e.extensions]) : i });
        }
        static create(t = {}) {
          let e = ht.resolve(t.extensions || [], new Map());
          let n = t.doc instanceof m ? t.doc : m.of((t.doc || "").split(e.staticFacet(Dt.lineSeparator) || F));
          let i = !t.selection ? V.single(0) : t.selection instanceof V ? t.selection : V.single(t.selection.anchor, t.selection.head);
          W(i, n.length);
      ...
      class _t {
        ...
        update(t) {
          ...
          return a.finishInner(
            this.nextLayer.isEmpty && !o.length ? _t.empty : this.nextLayer.update({ add: o, filter: r, filterFrom: i, filterTo: s })
          );
        }
        map(t) {
        ...
        static eq(t, e, n = 0, i) {
          ...
          for (;;) {
            if (h.to != o.to || !Xt(h.active, o.active) || (h.point && (!o.point || !h.point.eq(o.point)))) return false;
        ...
        static join(t) {
          ...
          for (let n = t.length - 2; n >= 0; n--) {
            for (let i = t[n]; i != _t.empty; i = i.nextLayer) e = new _t(i.chunkPos, i.chunk, e, Math.max(i.maxPoint, e.maxPoint));
          }
          return e;
        }
      }
      ...
      class Vt {
        ...
        finishInner(t) {
          ...
          let e = _t.create(this.chunkPos, this.chunks, this.nextLayer ? this.nextLayer.finishInner(t) : t, this.setMaxPoint);
          this.from = null;
          return e;
        }
      }
      ...
      function Qt(t, e, n, i, s, r) {
        ...
        for (;;) {
          ...
          let s = i < 0 ? t.to + o : n.to,
            a = Math.min(s, l);
          if (t.point || n.point) {
            if (!(t.point && n.point && (t.point == n.point || t.point.eq(n.point)) && Xt(t.activeForPoint(t.to), n.activeForPoint(n.to))))
