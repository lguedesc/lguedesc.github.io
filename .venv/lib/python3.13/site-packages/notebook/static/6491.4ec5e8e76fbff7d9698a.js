...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [6491],
  {
    /***/ 86491: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var parser = (function () {
        ...
        var parser2 = {
          ...
          table: [
            ...
            { 11: 23, 37: 24, 38: $V7, 39: $V8, 40: 27, 41: $V9, 42: $Va, 43: $Vb, 44: $Vc, 45: $Vd, 46: $Ve, 47: $Vf, 48: $Vg, 49: $Vh, 50: $Vi },
            {
              11: 39,
              13: 38,
              24: $Vj,
            ...
            o($Vn, [2, 8]),
            o($Vn, [2, 9]),
            o($Vo, [2, 37], { 40: 55, 41: $V9, 42: $Va, 43: $Vb, 44: $Vc, 45: $Vd, 46: $Ve, 47: $Vf, 48: $Vg, 49: $Vh, 50: $Vi }),
            o($Vo, [2, 38]),
            o($Vo, [2, 39]),
            o($Vp, [2, 40]),
            o($Vp, [2, 42]),
            ...
            drawableElement.push({
              ...
              data: this.getTickValues().map((tick) => ({
                path: `M ${this.getScaleValue(tick)},${
                  ...
                  y + this.boundingRect.height - this.axisConfig.tickLength - (this.showAxisLine ? this.axisConfig.axisLineWidth : 0)
                }`,
                strokeFill: this.axisThemeConfig.tickColor,
                strokeWidth: this.axisConfig.tickWidth,
              })),
      ...
      var BandAxis = class extends BaseAxis {
        ...
        recalculateScale() {
          this.scale = (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .scaleBand */.tiA)()
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
            .trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
        }
        getTickValues() {
      ...
      var LinePlot = class {
        ...
        getDrawableElement() {
          ...
          if (this.orientation === "horizontal") {
            path = (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .line */.jvg)()
              .y((d) => d[0])
              .x((d) => d[1])(finalData);
          } else {
            path = (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .line */.jvg)()
