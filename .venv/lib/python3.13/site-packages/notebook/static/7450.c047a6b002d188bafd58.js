...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7450],
  {
    /***/ 67450: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
...
*/
      ...
      const historyConfig = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Facet.define({
        combine(configs) {
          return (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.combineConfig)(
            configs,
            {
              minDepth: 100,
              newGroupDelay: 500,
...
*/
      ...
      class HistEvent {
        ...
        static fromJSON(json) {
          return new HistEvent(
            json.changes && _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.ChangeSet.fromJSON(json.changes),
            [],
            json.mapped && _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.ChangeDesc.fromJSON(json.mapped),
            json.startSelection && _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.fromJSON(json.startSelection),
            json.selectionsAfter.map(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.fromJSON)
          );
        }
      ...
      function mapEvent(event, mapping, extraSelections) {
        ...
        return new HistEvent(
          mappedChanges,
          _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateEffect.mapEffects(event.effects, mapping),
          fullMapping,
          ...
          if (
            ...
            ((!lastEvent.selectionsAfter.length &&
              ...
              new HistEvent(
                ...
                conc(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateEffect.mapEffects(event.effects, lastEvent.changes), lastEvent.effects),
                lastEvent.mapped,
...
*/
      ...
      function byCharLogical(state, range, forward) {
        ...
        else pos = line.from + (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(line.text, pos - line.from, forward);
...
*/
      ...
      function toGroupStart(view, pos, start) {
        ...
        let cat = categorize(start),
          initial = cat != _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Space;
        return (next) => {
          let nextCat = categorize(next);
          if (nextCat != _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Space) return initial && nextCat == cat;
          initial = false;
          return true;
        };
      }
...
*/
      const cursorGroupForwardWin = (view) => {
        return moveSel(view, (range) =>
          range.empty ? view.moveByChar(range, true, (start) => toGroupStart(view, range.head, start)) : rangeEnd(range, true)
        );
      };
      ...
      function moveBySubword(view, range, forward) {
        ...
        let cat = _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Space,
          pos = range.from,
          steps = 0;
        let done = false,
          sawUpper = false,
          ...
          if (cat == _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word) {
            if (next.toLowerCase() == next) {
              ...
              if (
                sawUpper &&
                forward &&
                categorize((ahead = view.state.sliceDoc(pos, pos + 1))) == _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word &&
        ...
        if (
          segmenter &&
          cat == _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word &&
          ...
          if (skipped.length > 1 && /[\u4E00-\uffff]/.test(skipped)) {
            ...
            if (segments.length > 1) {
              if (forward) return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(range.head + segments[1].index, -1);
...
*/
      ...
      function moveBySyntax(state, start, forward) {
        ...
        if (
          bracket &&
          (match = forward
            ? (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.matchBrackets)(state, pos.from, 1)
            : (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.matchBrackets)(state, pos.to, -1)) &&
          match.matched
        )
      ...
      function cursorByPage(view, forward) {
        ...
        if (page.selfScroll) {
          ...
          if (startPos && startPos.top > scrollTop && startPos.bottom < scrollBottom)
            effect = _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.scrollIntoView(selection.main.head, {
              y: "start",
...
*/
      const cursorLineStart = (view) =>
        moveSel(view, (range) => _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(view.lineBlockAt(range.head).from, 1));
      /**
Move the selection to the end of the line.
*/
      const cursorLineEnd = (view) =>
        moveSel(view, (range) => _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(view.lineBlockAt(range.head).to, -1));
      function toMatchingBracket(state, dispatch, extend) {
        let found = false,
          selection = updateSel(state.selection, (range) => {
            ...
            return extend
              ? _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(range.anchor, head)
              : _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(head);
          });
...
*/
      const selectLineStart = (view) =>
        extendSel(view, (range) => _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(view.lineBlockAt(range.head).from));
      /**
Move the selection head to the end of the line.
*/
      const selectLineEnd = (view) =>
        extendSel(view, (range) => _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(view.lineBlockAt(range.head).to));
      /**
...
*/
      const selectLine = ({ state, dispatch }) => {
        let ranges = selectedLineBlocks(state).map(({ from, to }) =>
          _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(from, Math.min(to + 1, state.doc.length))
        );
...
*/
      const simplifySelection = ({ state, dispatch }) => {
        let cur = state.selection,
          selection = null;
        if (cur.ranges.length > 1) selection = _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.create([cur.main]);
        else if (!cur.main.empty)
          selection = _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.create([
            _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(cur.main.head),
          ]);
      ...
      function deleteBy(target, by) {
        ...
        let changes = state.changeByRange((range) => {
          ...
          return from == to
            ...
            : {
                changes: { from, to },
                range: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(from, from < range.head ? -1 : 1),
              };
        });
          ...
          state.update(changes, {
            ...
            effects:
              event == "delete.selection"
                ? _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.announce.of(state.phrase("Selection deleted"))
                : undefined,
          })
        );
        return true;
      ...
      const deleteByChar = (target, forward, byIndentUnit) =>
        deleteBy(target, (range) => {
          ...
          if (
            ...
            let col = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.countColumn)(before, state.tabSize),
              drop =
                col % (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.getIndentUnit)(state) ||
                (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.getIndentUnit)(state);
            for (let i = 0; i < drop && before[before.length - 1 - i] == " "; i++) pos--;
            targetPos = pos;
          } else {
            targetPos =
              (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(line.text, pos - line.from, forward, forward) + line.from;
            if (targetPos == pos && line.number != (forward ? state.doc.lines : 1)) targetPos += forward ? 1 : -1;
            else if (!forward && /[\ufe00-\ufe0f]/.test(line.text.slice(targetPos - line.from, pos - line.from)))
              targetPos =
                (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(line.text, targetPos - line.from, false, false) + line.from;
          }
          return targetPos;
        });
      /**
      ...
      const transposeChars = ({ state, dispatch }) => {
        ...
        let changes = state.changeByRange((range) => {
          ...
          let from =
            pos == line.from
              ? pos - 1
              : (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(line.text, pos - line.from, false) + line.from;
          let to =
            pos == line.to
              ? pos + 1
              : (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(line.text, pos - line.from, true) + line.from;
          return {
...
*/
      ...
      function isBetweenBrackets(state, pos) {
        ...
        if (
          ...
          before.to <= pos &&
          after.from >= pos &&
          (closedBy = before.type.prop(_lezer_common__WEBPACK_IMPORTED_MODULE_3__.NodeProp.closedBy)) &&
...
*/
      ...
      function newlineAndIndent(atEof) {
        return ({ state, dispatch }) => {
          ...
          let changes = state.changeByRange((range) => {
            ...
            let cx = new _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.IndentContext(state, {
              simulateBreak: from,
            ...
            if (explode) insert.push((0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.indentString)(state, cx.lineIndent(line.from, -1)));
            return {
      ...
      function changeBySelectedLine(state, f) {
        ...
        return state.changeByRange((range) => {
          ...
          return {
            changes,
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(
...
*/
      const indentSelection = ({ state, dispatch }) => {
        ...
        let context = new _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.IndentContext(state, {
        ...
        dispatch(
          state.update(
            changeBySelectedLine(state, (line, changes) => {
              ...
              if (!space) return;
              let col = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.countColumn)(space, state.tabSize),
                keep = 0;
              let insert = (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.indentString)(
                state,
                Math.max(0, col - (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.getIndentUnit)(state))
              );
