...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5850],
  {
    /***/ 65850: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
   ...
   expressed by lezer's built-in tokenizer. */
      ...
      const parser = dist /* LRParser */.WQ.deserialize({
        ...
        tokenizers: [
          ...
          new dist /* LocalTokenGroup */.RA("j~RQYZXz{^~^O's~~aP!P!Qd~iO't~~", 25, 310),
        ],
...
*/
      const autoCloseTags = /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of((view, from, to, text, defaultInsert) => {
        ...
        let closeTags = state.changeByRange((range) => {
          var _a;
          let { head } = range,
            around = (0, dist_index_js_.syntaxTree)(state).resolveInner(head - 1, -1),
            name;
          ...
          if (state.doc.sliceString(head - 1, head) != text || (around.name == "JSXAttributeValue" && around.to > head));
            ...
            if (
              ...
              ((name = elementName(state.doc, base.firstChild, head)) ||
                ((_a = base.firstChild) === null || _a === void 0 ? void 0 : _a.name) == "JSXFragmentTag")
            ) {
              let insert = `${name}>`;
