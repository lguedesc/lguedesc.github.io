...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5261],
  {
    /***/ 25261: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var index_js_ = __webpack_require__(98273);
      ...
      var dist_index_js_ = __webpack_require__(82990); // CONCATENATED MODULE: ../node_modules/crelt/index.js
      function crelt() {
        var elt = arguments[0];
...
*/
      const gotoLine = (view) => {
        ...
        if (!panel) {
          ...
          if (view.state.field(dialogField, false) == null) effects.push(dist_index_js_.StateEffect.appendConfig.of([dialogField, baseTheme$1]));
...
*/
      ...
      function insideWordBoundaries(check, state, from, to) {
        return (
          (from == 0 || check(state.sliceDoc(from - 1, from)) != dist_index_js_.CharCategory.Word) &&
      ...
      function insideWord(check, state, from, to) {
        return (
          check(state.sliceDoc(from, from + 1)) == dist_index_js_.CharCategory.Word &&
        ...
        class {
          ...
          getDeco(view) {
            ...
            let range = sel.main,
              ...
              check = null;
            if (range.empty) {
              if (!conf.highlightWordAroundCursor) return index_js_.Decoration.none;
              ...
              if (len < conf.minSelectionLength || len > 200) return index_js_.Decoration.none;
              if (conf.wholeWords) {
            ...
            for (let part of view.visibleRanges) {
              ...
              while (!cursor.next().done) {
                ...
                if (!check || insideWordBoundaries(check, state, from, to)) {
                  ...
                  if (deco.length > conf.maxMatches) return index_js_.Decoration.none;
                }
              }
            }
      ...
      const selectWord = ({ state, dispatch }) => {
        ...
        let newSel = dist_index_js_.EditorSelection.create(
          selection.ranges.map((range) => state.wordAt(range.head) || dist_index_js_.EditorSelection.cursor(range.head)),
          selection.mainIndex
        );
    ...
    */
      ...
      function stringWordTest(doc, categorizer) {
        return (from, to, buf, bufPos) => {
          ...
          return (
            (categorizer(charBefore(buf, from - bufPos)) != dist_index_js_.CharCategory.Word ||
...
*/
      ...
      const matchMark = /*@__PURE__*/ index_js_.Decoration.mark({ class: "cm-searchMatch" }),
        selectedMatchMark = /*@__PURE__*/ index_js_.Decoration.mark({ class: "cm-searchMatch cm-searchMatch-selected" });
...
*/
      ...
      function defaultQuery(state, fallback) {
        ...
        return new SearchQuery({
          search: ((_a = fallback === null || fallback === void 0 ? void 0 : fallback.literal) !== null && _a !== void 0 ? _a : config.literal)
            ? selText
            : selText.replace(/\n/g, "\\n"),
          caseSensitive:
            (_b = fallback === null || fallback === void 0 ? void 0 : fallback.caseSensitive) !== null && _b !== void 0 ? _b : config.caseSensitive,
...
*/
      ...
      const searchExtensions = [searchState, /*@__PURE__*/ dist_index_js_.Prec.low(searchHighlighter), baseTheme];

      /***/
    },
  },
]);
//# sourceMappingURL=5261.f12a52481f4cee8ba676.js.map?v=f12a52481f4cee8ba676
