...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [2453],
  {
    /***/ 2520: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /***/ 82002: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 62453: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      var parser = (function () {
        var o = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (k, v, o2, l) {
          ...
          $VE = [1, 122];
        var parser2 = {
          trace: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function trace() {}, "trace"),
          yy: {},
          symbols_: {
            error: 2,
            start: 3,
          ...
          performAction: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function anonymous(
            yytext,
            yyleng,
            yylineno,
            yy,
            ...
            switch (yystate) {
              ...
              case 43:
                this.$ = $$[$0 - 3].concat([
                  { type: "option", optionText: yy.parseMessage($$[$0 - 1]), signalType: yy.LINETYPE.CRITICAL_OPTION },
                  $$[$0],
                ]);
                break;
              case 45:
              ...
              case 67:
                this.$ = [
                  $$[$0 - 3],
                  $$[$0 - 1],
                  { type: "addMessage", from: $$[$0 - 3].actor, to: $$[$0 - 1].actor, signalType: $$[$0 - 2], msg: $$[$0] },
                ];
                break;
              case 68:
          ...
          table: [
            ...
            { 3: 5, 4: $V0, 5: $V1, 6: $V2 },
            { 3: 6, 4: $V0, 5: $V1, 6: $V2 },
            o([1, 4, 5, 13, 14, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 54, 59, 60, 61, 62, 70], $V3, { 7: 7 }),
            { 1: [2, 1] },
            { 1: [2, 2] },
            {
              1: [2, 3],
            ...
            { 56: 124, 81: $VE },
            { 56: 125, 81: $VE },
            { 4: [1, 128], 5: [1, 130], 11: 127, 12: 129, 16: [1, 126], 50: $Vo, 52: $Vp, 53: $Vq },
            { 5: [1, 131] },
            o($Vx, [2, 19]),
            o($Vx, [2, 20]),
            o($Vx, [2, 22]),
      ...
      var SequenceDB = class {
        ...
        parseMessage(str) {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
        ...
        parseBoxData(str) {
          ...
          return {
            text: cleanedText
              ? (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .sanitizeText */.oO)(
                  cleanedText,
        ...
        addLinks(actorId, text) {
          ...
          try {
            let sanitizedText = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .sanitizeText */.oO)(
              text.text,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            );
        ...
        addProperties(actorId, text) {
          const actor = this.getActor(actorId);
          try {
            const sanitizedText = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .sanitizeText */.oO)(
              text.text,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            );
      ...
      var getStyles = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        (options) => `.actor {
...
`,
      ...
      var drawPopup = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        elem,
        actor,
        minMenuWidth,
        textAttrs,
      ...
      var popupMenuToggle = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (popId) {
        return (
          "var pu = document.getElementById('" + popId + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }"
        );
      }, "popupMenuToggle");
      var drawKatex = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        elem,
        textData,
        msgModel = null
      ) {
        let textElem = elem.append("foreignObject");
        const lines = await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .renderKatex */.uT)(
          textData.text,
          (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.iE)()
        );
      ...
      var drawText = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (elem, textData) {
        ...
        if (textData.valign !== void 0 && textData.textMargin !== void 0 && textData.textMargin > 0) {
          switch (textData.valign) {
            case "top":
            case "start":
              yfunc = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
            ...
            case "end":
              yfunc = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
                () => Math.round(textData.y + (prevTextHeight + textHeight + 2 * textData.textMargin) - textData.textMargin),
                "yfunc"
              );
              break;
          }
      ...
      var actorCnt = -1;
      var fixLifeLineHeights = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
      ...
      var drawActorTypeParticipant = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        elem,
        actor,
        conf2,
        isFooter
        ...
        if (actor.properties?.icon) {
          ...
          if (iconSrc.charAt(0) === "@") {
            (0, _chunk_D6G4REZN_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .drawEmbeddedImage */.rB)(
              g,
      ...
      var drawActorTypeActor = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        elem,
        actor,
        conf2,
        isFooter
      ...
      var drawActor = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        elem,
        actor,
        conf2,
        isFooter
      ...
      var drawBox = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (elem, box, conf2) {
        ...
        if (box.name) {
          _drawTextCandidateFunc(conf2)(box.name, g, box.x, box.y + (box.textMaxHeight || 0) / 2, box.width, 0, { class: "text" }, conf2);
        }
        g.lower();
      }, "drawBox");
      ...
      var drawActivation = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        elem,
        bounds2,
        verticalPos,
        conf2,
      ...
      var drawLoop = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        elem,
        loopModel,
        labelText,
        conf2
        ...
        const g = elem.append("g");
        const drawLoopLine = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
          startx,
          starty,
          stopx,
          stopy
        ...
        txt.fontWeight = fontWeight;
        txt.wrap = true;
        let textElem = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .hasKatex */.l0)(txt.text)
      ...
      var _drawTextCandidateFunc = /* @__PURE__ */ (function () {
        ...
        async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
          const dim = await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .calculateMathMLDimensions */.nH)(
            content,
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.iE)()
          );
          const s = g.append("switch");
          ...
          text
            ...
            .html(
              await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .renderKatex */.uT)(
                content,
                (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.iE)()
              )
            );
      ...
      var bounds = {
        ...
        createLoop: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        ...
        newLoop: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
          title = { message: void 0, wrap: false, width: void 0 },
          fill
        ) {
      ...
      var drawNote = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (elem, noteModel) {
        ...
        const textElem = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .hasKatex */.l0)(textObj.text)
      ...
      async function boundMessage(_diagram, msgModel) {
        ...
        const textDims = isKatexMsg
          ? await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .calculateMathMLDimensions */.nH)(
              message,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            )
          : _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
      ...
      var drawMessage = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        diagram2,
        msgModel,
        lineStartY,
        diagObj
        ...
        const textDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
          .calculateTextDimensions(message, messageFont(conf));
        const textObj = (0, _chunk_D6G4REZN_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getTextObj */.AD)();
        textObj.x = startx;
        textObj.y = starty + 10;
            ...
            line = diagram2
              ...
              .attr(
                ...
                `M  ${startx},${lineStartY} H ${
                  startx + _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(conf.width / 2, textWidth / 2)
      ...
      var addActorRenderingData = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        diagram2,
        actors,
        createdActors,
        actorKeys,
      ...
      var drawActors = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        diagram2,
        actors,
        actorKeys,
        isFooter
      ...
      var drawActorsPopup = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (
        diagram2,
        actors,
        actorKeys,
        doc
      ...
      function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
        ...
        if (msg.id && msg.message && loopWidths[msg.id]) {
          ...
          msg.message = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
            .wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
          msg.width = loopWidth;
          msg.wrap = true;
          const textDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
      ...
      var draw = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        _text,
        id,
        _version,
        diagObj
        ...
        const root =
          securityLevel === "sandbox"
            ? (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ys)(sandboxElement.nodes()[0].contentDocument.body)
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
          .debug(diagObj.db);
        const diagram2 =
          securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ys)(`[id="${id}"]`);
        ...
        for (const msg of messages) {
          if (actors.get(msg.to) && actors.get(msg.from)) {
            ...
            const wrappedMessage = msg.wrap
              ? _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
                  .wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont)
              : msg.message;
            const messageDimensions = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .hasKatex */.l0)(wrappedMessage)
              ? await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .calculateMathMLDimensions */.nH)(
                  msg.message,
                  (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
                )
      ...
      var getRequiredPopupWidth = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (actor) {
        ...
        for (const key in actor.links) {
          const labelDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
      ...
      async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
        ...
        for (const prop of actors.keys()) {
          ...
          if (actor.wrap) {
            actor.description = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
              .wrapLabel(actor.description, conf.width - 2 * conf.wrapPadding, actorFont(conf));
          }
          const actDims = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .hasKatex */.l0)(actor.description)
            ? await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .calculateMathMLDimensions */.nH)(
                actor.description,
                (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
              )
          ...
          actor.width = actor.wrap
            ? conf.width
            : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
          actor.height = actor.wrap
            ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(actDims.height, conf.height)
            : conf.height;
          maxHeight = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(maxHeight, actor.height);
        }
        ...
        boxes.forEach((box) => {
          ...
          if (box.wrap) {
            box.name = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
              .wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
          }
          const boxMsgDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
          ...
          const minWidth = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(
            totalWidth,
      ...
      var buildNoteModel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        msg,
        actors,
        diagObj
      ) {
        ...
        let textDimensions = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .hasKatex */.l0)(msg.message)
          ? await (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .calculateMathMLDimensions */.nH)(
              msg.message,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            )
        ...
        const noteModel = {
          width: shouldWrap
            ? conf.width
            : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(
                conf.width,
        ...
        if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
          noteModel.width = shouldWrap
            ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(conf.width, textDimensions.width)
            : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(
          ...
          noteModel.width = shouldWrap
            ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin)
            : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(
                fromActor.width / 2 + toActor.width / 2,
                textDimensions.width + 2 * conf.noteMargin
              );
          ...
          textDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
            .calculateTextDimensions(
              shouldWrap
                ? _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
                    .wrapLabel(
                      msg.message,
                      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(conf.width, fromActor.width),
                      noteFont(conf)
                    )
                : msg.message,
              noteFont(conf)
        ...
        if (shouldWrap) {
          noteModel.message = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
            .wrapLabel(msg.message, noteModel.width - 2 * conf.wrapPadding, noteFont(conf));
        }
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
          .debug(
      ...
      var buildMessageModel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(function (msg, actors, diagObj) {
        ...
        const msgDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
      ...
      var calculateLoopBounds = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (
        messages,
        actors,
        _maxWidthPerActor,
        diagObj
        ...
        for (const msg of messages) {
          ...
          if (isNote) {
            ...
            stack.forEach((stk) => {
              ...
              current.width =
                _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(current.width, Math.abs(current.from - current.to)) -
                conf.labelBoxWidth;
            });
          } else {
            ...
            if (msgModel.startx && msgModel.stopx && stack.length > 0) {
              stack.forEach((stk) => {
                ...
                if (msgModel.startx === msgModel.stopx) {
                  ...
                  current.width =
                    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.getMax(current.width, msgModel.width) -
                    conf.labelBoxWidth;
                }
              });
            }
