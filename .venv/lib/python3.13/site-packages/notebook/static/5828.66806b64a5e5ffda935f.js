...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5828],
  {
    /***/ 25828: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      function tokensFor(d) {
        return new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__ /* .ExternalTokenizer */.Jq((input) => {
          ...
          if (inString(next, Space)) {
            ...
            input.acceptToken(
              input.next == 46 /* Ch.Dot */ || input.peek(-word.length - 1) == 46 /* Ch.Dot */
                ? Identifier
      ...
      function maybeQuoteCompletions(quote, completions) {
        ...
        return completions.map((c) =>
          Object.assign(Object.assign({}, c), { label: c.label[0] == quote ? c.label : quote + c.label + quote, apply: undefined })
        );
      }
      const Span = /^\w*$/,
        QuotedSpan = /^[`'"]?\w*[`'"]?$/;
      ...
      function completeFromSchema(schema, tables, schemas, defaultTableName, defaultSchemaName, dialect) {
        var _a;
        let idQuote =
          ((_a = dialect === null || dialect === void 0 ? void 0 : dialect.spec.identifierQuotes) === null || _a === void 0 ? void 0 : _a[0]) || '"';
      ...
      function completeKeywords(keywords, upperCase, build) {
        let completions = Object.keys(keywords).map((keyword) =>
          build(upperCase ? keyword.toUpperCase() : keyword, completionType(keywords[keyword]))
        );
        return (0, _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_3__ /* .ifNotIn */.eC)(
          ["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", "."],
          (0, _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_3__ /* .completeFromList */.Mb)(completions)
        );
      }
      ...
      let parser = /*@__PURE__*/ parser$1.configure({
        props: [
          ...
          /*@__PURE__*/ (0, _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.styleTags)({
            ...
            Builtin: /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.standard(
            ...
            QuotedIdentifier: /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.special(
              _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.string
            ),
            SpecialVar: /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.special(
              _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.name
            ),
...
*/
      function schemaCompletionSource(config) {
        return config.schema
          ? completeFromSchema(config.schema, config.tables, config.schemas, config.defaultTable, config.defaultSchema, config.dialect || StandardSQL)
          : () => null;
      }
...
*/
      const MSSQL = /*@__PURE__*/ SQLDialect.define({
        ...
        types:
          SQLTypes + "bigint smallint smallmoney tinyint money real text nvarchar ntext varbinary image hierarchyid uniqueidentifier sql_variant xml",
        builtin:
