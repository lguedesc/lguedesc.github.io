...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [1584],
  {
    /***/ 31584: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
...
*/
    ...
    */
          ...
          if (!_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.prototype.hasOwnProperty("tree"))
            Object.defineProperty(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.prototype, "tree", {
              get() {
...
*/
    ...
    */
        work(until, upto) {
          ...
          if (
            this.tree != _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree.empty &&
            ...
            for (;;) {
              ...
              if (done) {
                this.fragments = this.withoutTempSkipped(
                  _lezer_common__WEBPACK_IMPORTED_MODULE_0__.TreeFragment.addTree(done, this.fragments, this.parse.stoppedAt != null)
                );
    ...
    */
        takeTree() {
          ...
          if (this.parse && (pos = this.parse.parsedPos) >= this.treeLen) {
            ...
            this.tree = tree;
            this.fragments = this.withoutTempSkipped(
              _lezer_common__WEBPACK_IMPORTED_MODULE_0__.TreeFragment.addTree(this.tree, this.fragments, true)
            );
            this.parse = null;
          }
        }
    ...
    */
      ...
      class LanguageState {
        ...
        apply(tr) {
          ...
          let upto =
            this.context.treeLen == tr.startState.doc.length ? undefined : Math.max(tr.changes.mapPos(this.context.treeLen), newCx.viewport.to);
      ...
      const isInputPending =
        typeof navigator != "undefined" && ((_a = navigator.scheduling) === null || _a === void 0 ? void 0 : _a.isInputPending)
          ? () => navigator.scheduling.isInputPending()
          : null;
      const parseWorker = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.fromClass(
        class ParseWorker {
          constructor(view) {
            this.view = view;
            this.working = null;
...
*/
      ...
      function maybeEnable(state, other) {
        return state.field(foldState, false)
          ? other
          : other.concat(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.appendConfig.of(codeFolding()));
      }
      /**
...
*/
      ...
      const foldWidget = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.replace({
...
*/
      function foldGutter(config = {}) {
        ...
        let markers = _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.fromClass(
          class {
            constructor(view) {
...
*/
    ...
    */
          ...
          this.scope =
            scopeOpt instanceof Language ? (type) => type.prop(languageDataProp) == scopeOpt.data : scopeOpt ? (type) => type == scopeOpt : undefined;
          this.style = (0, _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tagHighlighter)(
            specs.map((style) => ({
              tag: style.tag,
...
*/
      function syntaxHighlighting(highlighter, options) {
        ...
        if (highlighter instanceof HighlightStyle) {
          if (highlighter.module) ext.push(_codemirror_view__WEBPACK_IMPORTED_MODULE_2__.EditorView.styleModule.of(highlighter.module));
          themeType = highlighter.themeType;
        }
        if (options === null || options === void 0 ? void 0 : options.fallback) ext.push(fallbackHighlighter.of(highlighter));
        else if (themeType)
          ext.push(
            highlighterFacet.computeN([_codemirror_view__WEBPACK_IMPORTED_MODULE_2__.EditorView.darkTheme], (state) => {
...
*/
      ...
      class TreeHighlighter {
        ...
        buildDeco(view, highlighters) {
          if (!highlighters || !this.tree.length) return _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.none;
          let builder = new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSetBuilder();
            ...
            (0, _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.highlightTree)(
              ...
              (from, to, style) => {
                builder.add(
                  from,
                  to,
                  this.markCache[style] || (this.markCache[style] = _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({ class: style }))
                );
              },
              from,
              to
      ...
      const treeHighlighter = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.high(
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.fromClass(TreeHighlighter, {
...
*/
      const defaultHighlightStyle = /*@__PURE__*/ HighlightStyle.define([
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.meta, color: "#404740" },
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.link, textDecoration: "underline" },
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.heading, textDecoration: "underline", fontWeight: "bold" },
        ...
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.keyword, color: "#708" },
        {
          tag: [
        ...
        },
        {
          tag: [
            ...
            /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.special(_lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.string),
          ],
          color: "#e40",
        },
        {
        ...
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.className, color: "#167" },
        {
          tag: [
            /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.special(_lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.variableName),
        ...
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.comment, color: "#940" },
        { tag: _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tags.invalid, color: "#f00" },
      ]);
      ...
      const matchingMark = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({ class: "cm-matchingBracket" }),
        nonmatchingMark = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({ class: "cm-nonmatchingBracket" });
...
*/
      ...
      function matchingNodes(node, dir, brackets) {
        let byProp = node.prop(
          dir < 0 ? _lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeProp.openedBy : _lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeProp.closedBy
        );
    ...
    */
      ...
      function findState(lang, tree, off, startPos, before) {
        ...
        for (let i = tree.children.length - 1; i >= 0; i--) {
          ...
          let found =
            child instanceof _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree && pos < before && findState(lang, child, pos, startPos, before);
      ...
      class Parse {
        constructor(lang, input, fragments, ranges) {
          ...
          if (
            context &&
            this.parsedPos < context.viewport.from - 100000 /* C.MaxDistanceBeforeViewport */ &&
...
*/
      ...
      const isolateMarks = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.fromClass(
        class {
          constructor(view) {
            this.always =
            ...
            this.tree = syntaxTree(view.state);
            this.decorations =
              this.always || this.hasRTL ? buildDeco(view, this.tree, this.always) : _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.none;
          }
          update(update) {
            let always =
        ...
        },
        {
          provide: (plugin) => {
            function access(view) {
              var _a, _b;
              return (_b = (_a = view.plugin(plugin)) === null || _a === void 0 ? void 0 : _a.decorations) !== null && _b !== void 0
                ? _b
                : _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.none;
            }
            return [
              ...
              _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.lowest(
                _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.EditorView.bidiIsolatedRanges.of(access)
              ),
            ];
          },
        }
      ...
      const marks = {
        rtl: /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({
          ...
          inclusive: true,
          attributes: { dir: "rtl" },
          bidiIsolate: _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Direction.RTL,
        }),
        ltr: /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({
          class: "cm-iso",
          inclusive: true,
          attributes: { dir: "ltr" },
          bidiIsolate: _codemirror_view__WEBPACK_IMPORTED_MODULE_2__.Direction.LTR,
        }),
