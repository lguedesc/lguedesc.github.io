...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [4588],
  {
    /***/ 64588: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var view_dist_index_js_ = __webpack_require__(98273); // CONCATENATED MODULE: ../node_modules/@codemirror/lang-xml/dist/index.js
        ...
        return (cx) => {
          ...
          if (type == "openTag") {
            ...
            let options = closing.concat(
              ((parent === null || parent === void 0 ? void 0 : parent.children) || (context ? allElements : topElements)).map(
                (e) => e.openCompletion
              )
            );
...
*/
      const autoCloseTags = /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
        ...
        let closeTags = state.changeByRange((range) => {
          ...
          let after = (0, dist_index_js_.syntaxTree)(state).resolveInner(head, -1),
            name;
