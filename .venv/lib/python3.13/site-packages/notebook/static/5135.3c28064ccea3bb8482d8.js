    ...
    /***/ 45135: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      class NotebookShell extends widgets_dist_index_es6_js_.Widget {
        constructor() {
          ...
          const skipLinkWidgetHandler = (this._skipLinkWidgetHandler = new shell_Private.SkipLinkWidgetHandler(this));
       ...
       */
      const INotebookPathOpener = new dist_index_js_.Token("@jupyter-notebook/application:INotebookPathOpener"); // CONCATENATED MODULE: ../packages/application/lib/index.js
      // Copyright (c) Jupyter Development Team.
      // Distributed under the terms of the Modified BSD License.
