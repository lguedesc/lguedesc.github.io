...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [9442],
  {
    /***/ 69442: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      var src = __webpack_require__(83619); // CONCATENATED MODULE: ../node_modules/d3-sankey/node_modules/d3-array/src/min.js
      ...
      var parser = (function () {
        var o = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(function (k, v, o2, l) {
          ...
          $V2 = [1, 5, 10, 12];
        var parser2 = {
          trace: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(function trace() {}, "trace"),
          yy: {},
          symbols_: {
            error: 2,
            start: 3,
      ...
      var draw = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(function (text, id, _version, diagObj) {
        ...
        const root =
          securityLevel === "sandbox" ? (0, src /* select */.Ys)(sandboxElement.nodes()[0].contentDocument.body) : (0, src /* select */.Ys)("body");
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
      ...
      var getStyles = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(
        (options) => `.label {
