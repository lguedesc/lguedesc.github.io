...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7866],
  {
    /***/ 77866: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      function completeAttrName(state, schema, tree, from, to) {
        ...
        let names =
          info && info.globalAttrs === false ? localAttrs : localAttrs.length ? localAttrs.concat(schema.globalAttrNames) : schema.globalAttrNames;
        return { from, to, options: names.map((attrName) => ({ label: attrName, type: "property" })), validFor: identifier };
      }
      ...
      function htmlCompletionFor(schema, context) {
        let { state, pos } = context,
          tree = (0, language_dist_index_js_.syntaxTree)(state).resolveInner(pos, -1),
...
*/
      ...
      const defaultNesting = [
        ...
        { tag: "script", attrs: (attrs) => attrs.type == "text/babel" || attrs.type == "text/jsx", parser: lang_javascript_dist.jsxLanguage.parser },
        { tag: "script", attrs: (attrs) => attrs.type == "text/typescript-jsx", parser: lang_javascript_dist.tsxLanguage.parser },
        {
          tag: "script",
          attrs(attrs) {
      ...
      const defaultAttrs = /*@__PURE__*/ [
        { name: "style", parser: /*@__PURE__*/ lang_css_dist.cssLanguage.parser.configure({ top: "Styles" }) },
...
*/
      const autoCloseTags = /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
        ...
        let closeTags = state.changeByRange((range) => {
          ...
          let { head } = range,
            after = (0, language_dist_index_js_.syntaxTree)(state).resolveInner(head, -1),
            name;
          if (didType && text == ">" && after.name == "EndTag") {
            let tag = after.parent;
            if (
              ((_b = (_a = tag.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0 ? void 0 : _b.name) !=
                "CloseTag" &&
