...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [145],
  {
    /***/ 60145: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var parser = (function () {
        ...
        var parser2 = {
          trace: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function trace() {}, "trace"),
          yy: {},
          symbols_: {
            error: 2,
            start: 3,
          ...
          performAction: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function anonymous(
            yytext,
            yyleng,
            yylineno,
            yy,
      ...
      var setC4Type = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (c4TypeParam) {
        let sanitizedText = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .sanitizeText */.oO)(
          c4TypeParam,
          (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getConfig2 */.nV)()
        );
        c4Type = sanitizedText;
      }, "setC4Type");
      var addRel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        type,
        from,
        to,
        label,
      ...
      var addPersonOrSystem = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        alias,
        label,
        descr,
      ...
      var addContainer = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        alias,
        label,
        techn,
      ...
      var addComponent = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        alias,
        label,
        techn,
      ...
      var addPersonOrSystemBoundary = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        alias,
        label,
        type,
        tags,
      ...
      var addContainerBoundary = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        alias,
        label,
        type,
        tags,
      ...
      var addDeploymentNode = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        nodeType,
        alias,
        label,
        type,
      ...
      var updateElStyle = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        elementName,
        bgColor,
        fontColor,
      ...
      var updateRelStyle = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        from,
        to,
        textColor,
      ...
      var updateLayoutConfig = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        typeC4Shape,
        c4ShapeInRowParam,
      ...
      var c4Db_default = {
        ...
        getConfig: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(
          () => (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getConfig2 */.nV)().c4,
          "getConfig"
        ),
        clear,
        LINETYPE,
      ...
      var drawImage = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        elem,
        width,
        height,
        x,
        ...
        let sanitizedLink = link.startsWith("data:image/png;base64")
          ? link
          : (0, _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_4__ /* .sanitizeUrl */.N)(link);
            ...
            line
              ...
              .attr(
                ...
                "Mstartx,starty Qcontrolx,controly stopx,stopy "
                  ...
                  .replaceAll("controlx", rel.startPoint.x + (rel.endPoint.x - rel.startPoint.x) / 2 - (rel.endPoint.x - rel.startPoint.x) / 4)
      ...
      var Bounds = class {
        ...
        insert(c4Shape) {
          ...
          let _startx =
            this.nextData.startx === this.nextData.stopx ? this.nextData.stopx + c4Shape.margin : this.nextData.stopx + c4Shape.margin * 2;
      ...
      function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
        if (!c4Shape[textType].width) {
          if (c4ShapeTextWrap) {
            c4Shape[textType].text = (0, _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .wrapLabel */.X4)(
              c4Shape[textType].text,
              textLimitWidth,
              textConf
            );
            c4Shape[textType].textLines = c4Shape[textType].text.split(
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .common_default */.SY.lineBreakRegex
            ).length;
            c4Shape[textType].width = textLimitWidth;
            c4Shape[textType].height = (0, _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .calculateTextHeight */.XD)(
              c4Shape[textType].text,
              textConf
            );
          } else {
      ...
      var drawBoundary2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        diagram2,
        boundary,
        bounds
      ) {
        ...
        let textLimitWidth = (0, _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .calculateTextWidth */.Cq)(
          boundary.label.text,
          boundaryLabelConf
        );
      ...
      var drawC4ShapeArray = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        currentBounds,
        diagram2,
        c4ShapeArray2,
        c4ShapeKeys
      ...
      var drawRels2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (
        diagram2,
        rels2,
        getC4ShapeObj,
        diagObj
      ...
      function drawInsideBoundary(diagram2, parentBoundaryAlias, parentBounds, currentBoundaries, diagObj) {
        ...
        for (let [i, currentBoundary] of currentBoundaries.entries()) {
          ...
          if (i == 0 || i % c4BoundaryInRow2 === 0) {
            ...
            let _x =
              currentBounds.data.stopx !== currentBounds.data.startx ? currentBounds.data.stopx + conf.diagramMarginX : currentBounds.data.startx;
      ...
      var draw = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(function (_text, id, _version, diagObj) {
        ...
        const root =
          securityLevel === "sandbox"
            ? (0, d3__WEBPACK_IMPORTED_MODULE_3__ /* .select */.Ys)(sandboxElement.nodes()[0].contentDocument.body)
            : (0, d3__WEBPACK_IMPORTED_MODULE_3__ /* .select */.Ys)("body");
        let db = diagObj.db;
        diagObj.db.setWrap(conf.wrap);
        c4ShapeInRow2 = db.getC4ShapeInRow();
        c4BoundaryInRow2 = db.getC4BoundaryInRow();
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .log */.cM
          .debug(`C:${JSON.stringify(conf, null, 2)}`);
        const diagram2 =
          securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0, d3__WEBPACK_IMPORTED_MODULE_3__ /* .select */.Ys)(`[id="${id}"]`);
      ...
      var getStyles = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .__name */.eW)(
        (options) => `.person {
