...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [6301],
  {
    /***/ 66301: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      // src/diagrams/state/shapes.js
      var drawStartState = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(
        (g) =>
          g
            .append("circle")
            .attr("class", "start-state")
            .attr("r", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.sizeUnit)
            .attr(
              "cx",
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding +
                (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.sizeUnit
            )
            .attr(
              "cy",
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding +
      ...
      var drawDivider = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(
        (g) =>
          g
            .append("line")
            .style("stroke", "grey")
            .style("stroke-dasharray", "3")
            .attr("x1", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight)
            .attr("class", "divider")
            .attr("x2", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight * 2)
            .attr("y1", 0)
            .attr("y2", 0),
        "drawDivider"
      );
      var drawSimpleState = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)((g, stateDef) => {
        const state = g
          .append("text")
          .attr("x", 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr(
            "y",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight +
              2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding
          )
          .attr("font-size", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.fontSize)
          .attr("class", "state-title")
          .text(stateDef.id);
        const classBox = state.node().getBBox();
        g.insert("rect", ":first-child")
          .attr("x", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("y", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("width", classBox.width + 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("height", classBox.height + 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("rx", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.radius);
        return state;
      }, "drawSimpleState");
      var drawDescrState = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)((g, stateDef) => {
        ...
        const title = g
          ...
          .attr(
            "y",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight +
              1.3 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding
          )
          .attr("font-size", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.fontSize)
          .attr("class", "state-title")
        ...
        const description = g
          ...
          .attr(
            "y",
            titleHeight +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding * 0.4 +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.dividerMargin +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight
          )
        ...
        const descrLine = g
          .append("line")
          .attr("x1", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr(
            "y1",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding +
              titleHeight +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.dividerMargin / 2
          )
          .attr(
            "y2",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding +
        ...
        g.insert("rect", ":first-child")
          .attr("x", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("y", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr("width", width + 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
          .attr(
            "height",
            descrBox.height + titleHeight + 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding
          )
          .attr("rx", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.radius);
        return g;
      }, "drawDescrState");
      var addTitleAndBox = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)((g, stateDef, altBkg) => {
        ...
        const title = g
          .append("text")
          .attr("x", 0)
          .attr("y", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.titleShift)
          .attr("font-size", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.fontSize)
          .attr("class", "state-title")
          .text(stateDef.id);
        const titleBox = title.node().getBBox();
        ...
        g.insert("rect", ":first-child")
          ...
          .attr(
            ...
            graphBox.height +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.titleShift +
              1
          )
          .attr("rx", "0");
        ...
        g.insert("rect", ":first-child")
          ...
          .attr("width", width)
          .attr("height", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight * 3)
          .attr("rx", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.radius);
        g.insert("rect", ":first-child")
          .attr("x", startX)
          .attr(
          ...
          .attr("width", width)
          .attr("height", graphBox.height + 3 + 2 * (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.textHeight)
          .attr("rx", (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.radius);
        return g;
      }, "addTitleAndBox");
      var drawEndState = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)((g) => {
        g.append("circle")
          ...
          .attr(
            "r",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.sizeUnit +
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.miniPadding
          )
          .attr(
            "cx",
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding +
      ...
      var drawEdge = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(function (elem, path, relation) {
        ...
        const lineFunction = (0, d3__WEBPACK_IMPORTED_MODULE_11__ /* .line */.jvg)()
          .x(function (d) {
            return d.x;
          })
          .y(function (d) {
        ...
        if (relation.title !== void 0) {
          ...
          const { x, y } = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__ /* .utils_default */.w8
          ...
          for (let i = 0; i <= rows.length; i++) {
            ...
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .log */.cM
          ...
          label
            ...
            .attr("class", "box")
            .attr("x", x - maxWidth / 2 - (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding / 2)
            .attr("y", y - boxHeight / 2 - (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding / 2 - 3.5)
            .attr("width", maxWidth + (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding)
            .attr("height", boxHeight + (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.nV)().state.padding);
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .log */.cM
            .info(bounds);
        }
        edgeCount++;
      ...
      var setConf = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(function () {}, "setConf");
      ...
      var draw = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(function (text, id, _version, diagObj) {
        ...
        const root =
          securityLevel === "sandbox"
            ? (0, d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ys)(sandboxElement.nodes()[0].contentDocument.body)
            : (0, d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ys)("body");
      ...
      var renderDoc = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.eW)(
        (doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
              ...
              root
                ...
                .attr(
                  ...
                  "translate(" +
                    ...
                    "," +
                    (graph.node(v).y + (transformationLog[v] ? transformationLog[v].y : 0) - graph.node(v).height / 2) +
                    " )"
                );
          ...
          graph.edges().forEach(function (e) {
            if (e !== void 0 && graph.edge(e) !== void 0) {
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .log */.cM
                .debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
