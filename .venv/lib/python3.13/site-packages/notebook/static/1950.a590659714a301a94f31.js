...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [1950],
  {
    /***/ 11109: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
    ...
    /***/ 67406: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /***/ 26616: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const channel = (color, channel) => {
        return _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z.lang
          .round(_color_index_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z.parse(color)[channel]);
      };
      /* EXPORT */
    ...
    /***/ 31950: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      var parser = (function () {
        var o = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(function (k, v, o2, l) {
          ...
          $Ve = [1, 49];
        var parser2 = {
          trace: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(function trace() {}, "trace"),
          yy: {},
          symbols_: {
            error: 2,
            spaceLines: 3,
          ...
          performAction: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(function anonymous(
            yytext,
            yyleng,
            yylineno,
            yy,
      ...
      var sanitizeText2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        (txt) => _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .common_default */.SY.sanitizeText(txt, config),
        "sanitizeText"
      );
      ...
      var clear2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(() => {
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug("Clear called");
      ...
      var db = {
        getConfig: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
          () => (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig */.iE)().block,
          "getConfig"
        ),
        typeStr2Type,
        edgeTypeStr2Type,
      ...
      var getStyles = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        (options) => `.label {
...
`,
      ...
      var getMaxChildSize = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)((block) => {
        ...
        for (const child of block.children) {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("getMaxChildSize abc95 child:", child.id, "width:", width, "height:", height, "x:", x, "y:", y, child.type);
          if (child.type === "space") {
            continue;
          }
          if (width > maxWidth) {
      ...
      function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug("setBlockSizes abc95 (start)", block.id, block?.size?.x, "block width =", block?.size, "sieblingWidth", siblingWidth);
        if (!block?.size?.width) {
          block.size = {
            width: siblingWidth,
        ...
        if (block.children?.length > 0) {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("setBlockSizes abc95 maxWidth of", block.id, ":s children is ", maxWidth, maxHeight);
          for (const child of block.children) {
            if (child.size) {
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug(`abc95 Setting size of children of ${block.id} id=${child.id} ${maxWidth} ${maxHeight} ${JSON.stringify(child.size)}`);
              child.size.width = maxWidth * (child.widthInColumns ?? 1) + padding * ((child.widthInColumns ?? 1) - 1);
              child.size.height = maxHeight;
              child.size.x = 0;
              child.size.y = 0;
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug(`abc95 updating size of ${block.id} children child:${child.id} maxWidth:${maxWidth} maxHeight:${maxHeight}`);
            }
          }
          for (const child of block.children) {
          ...
          if (width < siblingWidth) {
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .debug(`Detected to small siebling: abc95 ${block.id} sieblingWidth ${siblingWidth} sieblingHeight ${siblingHeight} width ${width}`);
            width = siblingWidth;
            height = siblingHeight;
            const childWidth = (siblingWidth - xSize * padding - padding) / xSize;
            const childHeight = (siblingHeight - ySize * padding - padding) / ySize;
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .debug("Size indata abc88", block.id, "childWidth", childWidth, "maxWidth", maxWidth);
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .debug("Size indata abc88", block.id, "childHeight", childHeight, "maxHeight", maxHeight);
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug(
              `abc95 (finale calc) ${block.id} xSize ${xSize} ySize ${ySize} columns ${columns}${block.children.length} width=${Math.max(
                width,
                block.size?.width || 0
              )}`
            );
          if (width < (block?.size?.width || 0)) {
            ...
            if (num > 0) {
              ...
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug("abc95 (growing to fit) width", block.id, width, block.size?.width, childWidth);
              for (const child of block.children) {
                if (child.size) {
                  child.size.width = childWidth;
                }
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug("setBlockSizes abc94 (done)", block.id, block?.size?.x, block?.size?.width, block?.size?.y, block?.size?.height);
      }
      (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(setBlockSizes, "setBlockSizes");
      function layoutBlocks(block, db2) {
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug(`abc85 layout blocks (=>layoutBlocks) ${block.id} x: ${block?.size?.x} y: ${block?.size?.y} width: ${block?.size?.width}`);
        const columns = block.columns ?? -1;
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
        ...
        if (
          ...
          for (const child of block.children) {
            ...
            if (py != rowPos) {
              ...
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug("New row in layout for block", block.id, " and child ", child.id, rowPos);
            }
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .debug(
            ...
            if (parent.size) {
              ...
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug(
                  `abc91 layout blocks (calc) px, pyid:${child.id} startingPos=X${startingPosX} new startingPosX${
                    child.size.x
                  } ${halfWidth} padding=${padding} width=${width2} halfWidth=${halfWidth} => x:${child.size.x} y:${child.size.y} ${
                    child.widthInColumns
                  } (width * (child?.w || 1)) / 2 ${(width2 * (child?.widthInColumns ?? 1)) / 2}`
                );
              startingPosX = child.size.x + halfWidth;
              child.size.y = parent.size.y - parent.size.height / 2 + py * (height + padding) + height / 2 + padding;
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
                .debug(
                  `abc88 layout blocks (calc) px, pyid:${child.id}startingPosX${startingPosX}${padding}${halfWidth}=>x:${child.size.x}y:${
                    child.size.y
                  }${child.widthInColumns}(width * (child?.w || 1)) / 2${(width2 * (child?.widthInColumns ?? 1)) / 2}`
                );
            }
            if (child.children) {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug(`layout blocks (<==layoutBlocks) ${block.id} x: ${block?.size?.x} y: ${block?.size?.y} width: ${block?.size?.width}`);
      }
      ...
      var createLabel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        (_vertexText, style, isTitle, isNode) => {
          ...
          if (
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .evaluate */.ku)(
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)().flowchart.htmlLabels
            )
          ) {
            ...
            const node = {
              isNode,
              label: (0, _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .replaceIconSubstring */.EY)(
                (0, _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .decodeEntities */.SH)(vertexText)
              ),
      ...
      var addEdgeMarkers = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
      ...
      var addEdgeMarker = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
      ...
      var insertEdgeLabel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)((elem, edge) => {
        ...
        const labelElement =
          edge.labelType === "markdown"
            ? (0, _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .createText */.rw)(
                elem,
                edge.label,
                {
      ...
      var positionEdgeLabel = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)((edge, paths) => {
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .debug("Moving label abc88 ", edge.id, edge.label, edgeLabels[edge.id], paths);
        ...
        if (edge.label) {
          ...
          let y = edge.y;
          if (path) {
            const pos = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .utils_default */.w8
              .calcLabelPosition(path);
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .debug("Moving label " + edge.label + " from (", x, ",", y, ") to (", pos.x, ",", pos.y, ") abc88");
        ...
        if (edge.startLabelLeft) {
          ...
          if (path) {
            const pos = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .utils_default */.w8
              .calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
            x = pos.x;
            y = pos.y;
          }
  ...
  node        : x:${node.x} y:${node.y} w:${node.width} h:${node.height}`);
        ...
        if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug(`abc89 topp/bott calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
          return res;
        } else {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
          if (r === 0) {
            _x = outsidePoint.x;
            _y = outsidePoint.y;
          }
      ...
      var insertEdge = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(function (
        elem,
        e,
        edge,
        clusterDb,
        ...
        let url = "";
        if (
          (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)().flowchart.arrowMarkerAbsolute ||
          (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)().state.arrowMarkerAbsolute
        ) {
      ...
      var getArrowPoints = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
      ...
      var labelHelper = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        async (parent, node, _classes, isNode) => {
          const config2 = (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)();
          let classes2;
          const useHtmlLabels =
            node.useHtmlLabels || (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .evaluate */.ku)(config2.flowchart.htmlLabels);
          if (!_classes) {
          ...
          if (node.labelType === "markdown") {
            text = (0, _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .createText */.rw)(
              label,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .sanitizeText */.oO)(
                (0, _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .decodeEntities */.SH)(labelText),
                config2
              ),
              {
                useHtmlLabels,
      ...
      var circle2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(async (parent, node) => {
        ...
        node.intersect = function (point2) {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .info("Circle intersect", node, bbox.width / 2 + halfPadding, point2);
      ...
      var doublecircle = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(async (parent, node) => {
        ...
        node.intersect = function (point2) {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .info("DoubleCircle intersect", node, bbox.width / 2 + halfPadding + gap, point2);
      ...
      var class_box = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)((parent, node) => {
        ...
        node.classData.members.forEach((member) => {
          ...
          const lbl = labelContainer
            .node()
            .appendChild(createLabel_default(parsedText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
        ...
        node.classData.methods.forEach((member) => {
          ...
          const lbl = labelContainer
            .node()
            .appendChild(createLabel_default(displayText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
          let bbox = lbl.getBBox();
          if (
            (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .evaluate */.ku)(
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)().flowchart.htmlLabels
      ...
      var positionNode = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)((node) => {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
          .trace("Transforming node", node.diff, node, "translate(" + (node.x - node.width / 2 - 5) + ", " + node.width / 2 + ")");
        const padding2 = 8;
      ...
      var draw = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(async function (text, id, _version, diagObj) {
        ...
        const root =
          securityLevel === "sandbox"
            ? (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ys)(sandboxElement.nodes()[0].contentDocument.body)
