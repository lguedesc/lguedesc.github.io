...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5573],
  {
    /***/ 5573: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var react_index_js_default = /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ../packages/notebook-extension/lib/trusted.js
      /**
      ...
      const TrustedButton = ({ notebook, translator }) => {
        ...
        return react_index_js_default().createElement(
          "button",
          {
            ...
            title: trusted ? trans.__("JavaScript enabled for notebook display") : trans.__("JavaScript disabled for notebook display"),
          },
      ...
      const kernelLogo = {
        ...
        activate: (app, shell, toolbarRegistry) => {
          ...
          const onChange = async () => {
            ...
            const name =
              (_c =
                (_b = (_a = current.sessionContext.session) === null || _a === void 0 ? void 0 : _a.kernel) === null || _b === void 0
                  ? void 0
                  : _b.name) !== null && _c !== void 0
                ? _c
                : "";
            const spec =
              (_e = (_d = serviceManager.kernelspecs) === null || _d === void 0 ? void 0 : _d.specs) === null || _e === void 0
                ? void 0
                : _e.kernelspecs[name];
            if (!spec) {
      ...
      const editNotebookMetadata = {
        ...
        activate: (app, palette, translator, notebookTools) => {
          ...
          commands.addCommand(CommandIDs.openEditNotebookMetadata, {
              ...
              if (!commands.isToggled(command, args)) {
                await commands.execute(command, args).then((_) => {
                  ...
                  if (notebookTools) {
                    ...
                    tools.forEach((tool) => {
                      if (tool.widget.title.label === trans.__("Advanced Tools") && tool.collapsed) {
                        tool.toggle();
                      }
                    });
                  }
            ...
            isVisible: () => shell.currentWidget !== null && shell.currentWidget instanceof notebook_lib_index_js_.NotebookPanel,
          });
          if (palette) {
            palette.addItem({
