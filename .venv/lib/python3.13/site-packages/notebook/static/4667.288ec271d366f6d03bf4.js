...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [4667],
  {
    /***/ 54667: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var parser = (function () {
        ...
        var parser2 = {
          ...
          table: [
            ...
            { 1: [3] },
            o($V0, [2, 2], { 5: 3 }),
            { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: $V1, 12: $V2, 14: $V3, 16: $V4, 17: $V5, 18: 14, 19: 15, 20: $V6, 21: $V7 },
            o($V0, [2, 7], { 1: [2, 1] }),
            o($V0, [2, 3]),
            { 9: 18, 11: $V1, 12: $V2, 14: $V3, 16: $V4, 17: $V5, 18: 14, 19: 15, 20: $V6, 21: $V7 },
            o($V0, [2, 5]),
            o($V0, [2, 6]),
            o($V0, [2, 8]),
            { 13: [1, 19] },
      ...
      var tasks = [];
      var rawTasks = [];
      var getCommonDb = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(
        () => _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .commonDb_exports */.LJ,
        "getCommonDb"
      );
      ...
      var drawFace = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(function (element, faceData) {
        ...
        function smile(face2) {
          const arc = (0, d3__WEBPACK_IMPORTED_MODULE_1__ /* .arc */.Nb1)()
      ...
      function wrap(text, width) {
        text.each(function () {
          var text2 = (0, d3__WEBPACK_IMPORTED_MODULE_1__ /* .select */.Ys)(this),
            words = text2
              .text()
              .split(/(\s+|<br>)/)
              .reverse(),
      ...
      var drawTasks = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(function (
        diagram2,
        tasks2,
        sectionColor,
        masterX,
      ...
      var drawEvents = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(function (
        diagram2,
        events,
        sectionColor,
        masterX,
      ...
      var timelineRenderer_default = {
        setConf: /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(() => {}, "setConf"),
        draw,
      };
    ...
    `;
      ...
      var getStyles = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(
        (options) => `
  .edge {
    stroke-width: 3;
  }
