...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7154],
  {
    ...
    /***/ 2362: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __read =
        (this && this.__read) ||
        function (o, n) {
          var m = typeof Symbol === "function" && o[Symbol.iterator];
    ...
    /***/ 55661: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __read =
        (this && this.__read) ||
        function (o, n) {
          var m = typeof Symbol === "function" && o[Symbol.iterator];
    ...
    /***/ 26539: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
    ...
    /***/ 42757: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 32742: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 31201: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
        ...
        SubsupItem.prototype.checkItem = function (item) {
          ...
          if (_super.prototype.checkItem.call(this, item)[1]) {
            ...
            throw new (TexError_js_1.default.bind.apply(
              ...
              __spreadArray([void 0, error[0], error[1]], __read(error.splice(2)), false)
            ))();
          }
          return null;
        };
      ...
      var LeftItem = (function (_super) {
        ...
        LeftItem.prototype.checkItem = function (item) {
          ...
          if (item.isKind("middle")) {
            ...
            this.Push(
              this.create("node", "TeXAtom", [], { texClass: MmlNode_js_1.TEXCLASS.CLOSE }),
              this.create("token", "mo", def, item.getProperty("delim")),
              this.create("node", "TeXAtom", [], { texClass: MmlNode_js_1.TEXCLASS.OPEN })
            );
            this.env = {};
            return [[this], true];
          }
    ...
    /***/ 23430: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __createBinding =
        (this && this.__createBinding) ||
        (Object.create
          ? function (o, m, k, k2) {
      ...
      new sm.CharacterMap("mathchar0mo", ParseMethods_js_1.default.mathchar0mo, {
        ...
        intop: ["\u222B", { texClass: MmlNode_js_1.TEXCLASS.OP, movesupsub: true, movablelimits: true }],
    ...
    /***/ 76914: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __assign =
        (this && this.__assign) ||
        function () {
          __assign =
      ...
      BaseMethods.MathFont = function (parser, name, variant) {
        ...
        var mml = new TexParser_js_1.default(
          text,
          __assign(__assign({}, parser.stack.env), { font: variant, multiLetterIdentifiers: /^[a-zA-Z]+/, noAutoOP: true }),
      ...
      BaseMethods.FrameBox = function (parser, name) {
        ...
        var node = parser.create("node", "TeXAtom", [parser.create("node", "menclose", mml, { notation: "box" })], {
          texClass: MmlNode_js_1.TEXCLASS.ORD,
        });
        parser.Push(node);
      };
