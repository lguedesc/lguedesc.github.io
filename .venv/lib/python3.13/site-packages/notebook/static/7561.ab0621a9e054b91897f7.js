...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7561],
  {
    ...
    /***/ 7561: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var graphlib = __webpack_require__(67406); // CONCATENATED MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/dagre-OKDRZEBW.mjs
      ...
      var isDescendant = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)((id, ancestorId) => {
        ...
        chunk_YTJNT7DU /* log */.cM
          .trace("In isDescendant", ancestorId, " ", id, " = ", ancestorDescendants.includes(id));
      ...
      var copy = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)((clusterId, graph, newGraph, rootId) => {
        chunk_YTJNT7DU /* log */.cM
          .warn("Copying children of ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
        ...
        nodes.forEach((node) => {
          if (graph.children(node).length > 0) {
            ...
            if (clusterId !== rootId && node !== clusterId) {
              ...
              chunk_YTJNT7DU /* log */.cM
                .info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
              chunk_YTJNT7DU /* log */.cM
                .debug("Not Setting parent for node=", node, "cluster!==rootId", clusterId !== rootId, "node!==clusterId", node !== clusterId);
            }
            ...
            edges.forEach((edge) => {
              ...
              try {
                if (edgeInCluster(edge, rootId)) {
                  ...
                  chunk_YTJNT7DU /* log */.cM
                    .info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
                } else {
                  chunk_YTJNT7DU /* log */.cM
                    .info("Skipping copy of edge ", edge.v, "-->", edge.w, " rootId: ", rootId, " clusterId:", clusterId);
                }
              } catch (e) {
                chunk_YTJNT7DU /* log */.cM
                  .error(e);
      ...
      var adjustClustersAndEdges = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)((graph, depth) => {
        ...
        graph.nodes().forEach(function (id) {
          ...
          if (children.length > 0) {
            chunk_YTJNT7DU /* log */.cM
              .warn("Cluster identified", id, " Replacement id in edges: ", findNonClusterChild(id, graph, id));
        ...
        graph.edges().forEach(function (e) {
          ...
          chunk_YTJNT7DU /* log */.cM
            .warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
          let v = e.v;
          let w = e.w;
          chunk_YTJNT7DU /* log */.cM
            .warn("Fix XXX", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb.get(e.v), " --- ", clusterDb.get(e.w));
      ...
      var extractor = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)((graph, depth) => {
        ...
        for (const node of nodes) {
          ...
          if (!clusterDb.has(node)) {
            ...
            chunk_YTJNT7DU /* log */.cM
              .warn("Cluster without external connections, without a parent and with children", node, depth);
            ...
            chunk_YTJNT7DU /* log */.cM
              .warn("New graph after copy node: (", node, ")", write(clusterGraph));
            chunk_YTJNT7DU /* log */.cM
      ...
      var sortNodesByHierarchy = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(
      ...
      var recursiveRender = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
        ...
        await Promise.all(
          graph.nodes().map(async function (v) {
            ...
            chunk_YTJNT7DU /* log */.cM
              .info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
            if (node?.clusterNode) {
              chunk_YTJNT7DU /* log */.cM
              ...
              if (graph.children(v).length > 0) {
                chunk_YTJNT7DU /* log */.cM
                  .trace("Cluster - the non recursive path XBX", v, node.id, node, node.width, "Graph:", graph);
                chunk_YTJNT7DU /* log */.cM
                  .trace(findNonClusterChild(node.id, graph));
                clusterDb.set(node.id, { id: findNonClusterChild(node.id, graph), node });
              } else {
                chunk_YTJNT7DU /* log */.cM
                  .trace("Node - the non recursive path XAX", v, nodes, graph.node(v), dir);
        ...
        const processEdges = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.eW)(async () => {
          const edgePromises = graph.edges().map(async function (e) {
            ...
            chunk_YTJNT7DU /* log */.cM
              .info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
            chunk_YTJNT7DU /* log */.cM
              .info("Fix", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb.get(e.v), clusterDb.get(e.w));
        ...
        await Promise.all(
          sortNodesByHierarchy(graph).map(async function (v) {
            const node = graph.node(v);
            chunk_YTJNT7DU /* log */.cM
              .info("Position XBX => " + v + ": (" + node.x, "," + node.y, ") width: ", node.width, " height: ", node.height);
            if (node?.clusterNode) {
              node.y += subGraphTitleTotalMargin;
              chunk_YTJNT7DU /* log */.cM
                .info("A tainted cluster node XBX1", v, node.id, node.width, node.height, node.x, node.y, graph.parent(v));
              clusterDb.get(node.id).node = node;
              (0, chunk_HRU6DDCH /* positionNode */.aH)(node);
            } else {
              if (graph.children(v).length > 0) {
                chunk_YTJNT7DU /* log */.cM
                  .info("A pure cluster node XBX1", v, node.id, node.x, node.y, node.width, node.height, graph.parent(v));
                ...
                chunk_YTJNT7DU /* log */.cM
                  .debug("OffsetY", offsetY, "labelHeight", labelHeight, "halfPadding", halfPadding);
        ...
        graph.edges().forEach(function (e) {
          const edge = graph.edge(e);
          chunk_YTJNT7DU /* log */.cM
            .info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
