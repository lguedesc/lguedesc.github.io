...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [8218],
  {
    /***/ 68218: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var parser = (function () {
        ...
        var parser2 = {
          ...
          table: [
            ...
            { 3: 5, 4: $V0, 5: $V1, 6: $V2 },
            { 3: 6, 4: $V0, 5: $V1, 6: $V2 },
            o([1, 4, 5, 16, 17, 19, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], $V3, { 7: 7 }),
            { 1: [2, 1] },
            { 1: [2, 2] },
            {
              1: [2, 3],
      ...
      var getDir = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
      ...
      var draw = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(async function (text, id, _version, diag) {
        ...
        _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
          .insertTitle(svg, "statediagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
      ...
      var setupDoc = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
              ...
              case STMT_RELATION:
                {
                  ...
                  const edgeData = {
                    ...
                    style: G_EDGE_STYLE,
                    labelStyle: "",
                    label: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
                      item.description,
      ...
      var getDir2 = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        (parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
          let dir = defaultDir;
          if (parsedItem.doc) {
            for (const parsedItemDoc of parsedItem.doc) {
      ...
      var dataFetcher = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
          ...
          if (itemId !== "root") {
            ...
            if (!nodeDb.get(itemId)) {
              nodeDb.set(itemId, {
                id: itemId,
                shape,
                description: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
                  itemId,
                  (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
                ),
            ...
            if (parsedItem.description) {
              ...
              newNode.description = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeTextOrArray(
                newNode.description,
                (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
              );
            }
            ...
            if (parent && parent.id !== "root") {
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
                .trace("Setting node ", itemId, " to be child of its parent ", parent.id);
      ...
      var clone = /* @__PURE__ */ (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
      ...
      var StateDB = class {
        ...
        extract(_doc) {
          ...
          this.clear(true);
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
            .info("Extract initial document:", doc);
          doc.forEach((item) => {
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.cM
              .warn("Statement", item.stmt);
            switch (item.stmt) {
              case STMT_STATE:
        ...
        addState(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes = null, styles = null, textStyles = null) {
          ...
          if (note) {
            ...
            doc2.note = note;
            doc2.note.text = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
              doc2.note.text,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            );
          }
        ...
        addRelationObjs(item1, item2, relationTitle) {
          ...
          this.currentDocument.relations.push({
            id1,
            id2,
            relationTitle: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
              relationTitle,
              (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
            ),
          });
        ...
        addRelation(item1, item2, title) {
          if (typeof item1 === "object") {
            ...
            this.currentDocument.relations.push({
              id1,
              id2,
              title: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
                title,
                (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)()
              ),
            });
