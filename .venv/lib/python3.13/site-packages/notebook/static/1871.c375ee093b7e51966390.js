(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [1871, 7634, 9531, 8701],
  {
    /***/ 40018: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      class ArrayField extends index_js_.Component {
        ...
        get itemTitle() {
          ...
          return get_default()(
            ...
            get_default()(schema, [lib_index_js_.ITEMS_KEY, "description"], translateString(lib_index_js_.TranslatableString.ArrayItemTitle))
          );
        }
        ...
        render() {
          ...
          if (!(lib_index_js_.ITEMS_KEY in schema)) {
            ...
            return (0, jsx_runtime.jsx)(UnsupportedFieldTemplate, {
              schema: schema,
              idSchema: idSchema,
              reason: translateString(lib_index_js_.TranslatableString.MissingItems),
              registry: registry,
            });
          }
      ...
      class AnyOfField extends index_js_.Component {
        ...
        render() {
          ...
          const translateEnum = title ? lib_index_js_.TranslatableString.TitleOptionPrefix : lib_index_js_.TranslatableString.OptionPrefix;
          ...
          return (0, jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              option !== null && (0, jsx_runtime.jsx)(_SchemaField, { ...this.props, schema: optionSchema }),
            ],
          });
        }
      }
      ...
      function ve(e, t) {
        ...
        return {
          ...
          render: (t, n, i) =>
            e(
              t.ordered ? "ol" : "ul",
              { key: i.key, start: t.type === r.orderedList ? t.start : void 0 },
      ...
      function Te(e, t, n) {
        ...
        return (n.inline = !1), l.length ? { align: i, cells: l, header: a, type: r.table } : { children: a, type: r.paragraph };
      }
      function Be(e, t) {
      ...
      function Qe(n = "", i = {}) {
        function d(e, n, ...r) {
          ...
          return i.createElement(
            ...
            t({}, n, l, { className: Ze(null == n ? void 0 : n.className, l.className) || void 0 }),
            ...r
          );
        }
        function W(e) {
          ...
          if (n.length > 1 || i.forceWrapper) l = n;
            ...
            if (1 === n.length) return (l = n[0]), "string" == typeof l ? d("span", { key: "outer" }, l) : l;
            l = null;
          }
                ...
                if (-1 !== r) {
                  ...
                  const s = (t[c] = (function (e, t, n, r) {
                    return "style" === t
                      ...
                      : "href" === t || "src" === t
                        ? r(n, e, t)
                        : (n.match(R) && (n = n.slice(1, n.length - 1)), "true" === n || ("false" !== n && n));
                  })(e, a, o, i.sanitizer));
        ...
        (i.overrides = i.overrides || {}),
          ...
          (i.namedCodesToUnicode = i.namedCodesToUnicode ? t({}, a, i.namedCodesToUnicode) : a),
          ...
          V = {
            [r.blockQuote]: {
              ...
              render(e, t, n) {
                ...
                return (
                  e.alert &&
                    ((l.className = "markdown-alert-" + i.slugify(e.alert.toLowerCase(), ze)),
                    e.children.unshift({
                      attrs: {},
            ...
            [r.breakLine]: { match: Ue(h), order: 1, parse: Ge, render: (e, t, n) => d("br", { key: n.key }) },
            [r.breakThematic]: { match: Ie(m), order: 1, parse: Ge, render: (e, t, n) => d("hr", { key: n.key }) },
            [r.codeBlock]: {
              match: Ie(y),
              order: 0,
              parse: (e) => ({ lang: void 0, text: Ee(e[0].replace(/^ {4}/gm, "")).replace(te, "$1") }),
              render: (e, n, r) => d("pre", { key: r.key }, d("code", t({}, e.attrs, { className: e.lang ? `lang-${e.lang}` : "" }), e.text)),
            },
            [r.codeFenced]: {
              match: Ie(g),
              order: 0,
              parse: (e) => ({ attrs: Z("code", e[3] || ""), lang: e[2] || void 0, text: e[4].replace(te, "$1"), type: r.codeBlock }),
            },
            [r.codeInline]: {
              match: Re(k),
              order: 3,
            ...
            [r.footnote]: { match: Ie(v), order: 0, parse: (e) => (q.push({ footnote: e[2], identifier: e[1] }), {}), render: We },
            [r.footnoteReference]: {
              match: Me(C),
              order: 1,
              parse: (e) => ({ target: `#${i.slugify(e[1], ze)}`, text: e[1] }),
              render: (e, t, n) => d("a", { key: n.key, href: i.sanitizer(e.target, "a", "href") }, d("sup", { key: n.key }, e.text)),
            },
            [r.gfmTask]: {
              match: Me(w),
              order: 1,
              parse: (e) => ({ completed: "x" === e[1].toLowerCase() }),
              render: (e, t, n) => d("input", { checked: e.completed, key: n.key, readOnly: !0, type: "checkbox" }),
            },
            [r.heading]: {
              match: Ie(i.enforceAtxHeadings ? z : E),
              order: 1,
              parse: (e, t, n) => ({ children: He(t, e[2], n), id: i.slugify(e[2], ze), level: e[1].length }),
              render: (e, t, n) => d(`h${e.level}`, { id: e.id, key: n.key }, t(e.children, n)),
            },
            [r.headingSetext]: {
              match: Ie(L),
              order: 0,
              parse: (e, t, n) => ({ children: He(t, e[1], n), level: "=" === e[2] ? 1 : 2, type: r.heading }),
            },
            [r.htmlBlock]: {
              match: Ue(A),
              order: 1,
              ...
              render: (e, n, r) => d(e.tag, t({ key: r.key }, e.attrs), e.text || (e.children ? n(e.children, r) : "")),
            },
            [r.htmlSelfClosing]: {
              match: Ue(M),
              order: 1,
            ...
            [r.htmlComment]: { match: Ue(B), order: 1, parse: () => ({}), render: We },
            [r.image]: {
              match: Re($e),
              order: 1,
              parse: (e) => ({ alt: e[1], target: je(e[2]), title: e[3] }),
              render: (e, t, n) => d("img", { key: n.key, alt: e.alt || void 0, title: e.title || void 0, src: i.sanitizer(e.target, "img", "src") }),
            },
            [r.link]: {
              match: Me(Ce),
              order: 3,
              parse: (e, t, n) => ({ children: Pe(t, e[1], n), target: je(e[2]), title: e[3] }),
              render: (e, t, n) => d("a", { key: n.key, href: i.sanitizer(e.target, "a", "href"), title: e.title }, t(e.children, n)),
            },
            [r.linkAngleBraceStyleDetector]: {
              match: Me(D),
              order: 0,
              parse: (e) => ({ children: [{ text: e[1], type: r.text }], target: e[1], type: r.link }),
            },
            [r.linkBareUrlDetector]: {
              match: Oe((e, t) => (t.inAnchor || i.disableAutoLink ? null : Me(I)(e, t))),
              order: 0,
              parse: (e) => ({ children: [{ text: e[1], type: r.text }], target: e[1], title: void 0, type: r.link }),
            },
            [r.linkMailtoDetector]: {
              ...
              parse(e) {
                let t = e[1],
                  n = e[1];
                return s.test(n) || (n = "mailto:" + n), { children: [{ text: t.replace("mailto:", ""), type: r.text }], target: n, type: r.link };
              },
            },
            [r.orderedList]: ve(d, 1),
            [r.unorderedList]: ve(d, 2),
            [r.newlineCoalescer]: { match: Ie(x), order: 3, parse: Ge, render: () => "\n" },
            [r.paragraph]: { match: Oe(De), order: 3, parse: Fe, render: (e, t, n) => d("p", { key: n.key }, t(e.children, n)) },
            [r.ref]: { match: Me(H), order: 0, parse: (e) => ((Q[e[1]] = { target: e[2], title: e[4] }), {}), render: We },
            [r.refImage]: {
              match: Re(P),
              order: 0,
              parse: (e) => ({ alt: e[1] || void 0, ref: e[2] }),
              render: (e, t, n) =>
                Q[e.ref] ? d("img", { key: n.key, alt: e.alt, src: i.sanitizer(Q[e.ref].target, "img", "src"), title: Q[e.ref].title }) : null,
            },
            [r.refLink]: {
              match: Me(_),
              order: 0,
              parse: (e, t, n) => ({ children: t(e[1], n), fallbackChildren: e[0], ref: e[2] }),
              render: (e, t, n) =>
                Q[e.ref]
                  ? d("a", { key: n.key, href: i.sanitizer(Q[e.ref].target, "a", "href"), title: Q[e.ref].title }, t(e.children, n))
            ...
            [r.text]: {
              match: Ue(ne),
              order: 4,
              parse: (e) => ({ text: e[0].replace(T, (e, t) => (i.namedCodesToUnicode[t] ? i.namedCodesToUnicode[t] : e)) }),
              render: (e) => e.text,
            },
            [r.textBolded]: {
              match: Re(X),
            ...
            [r.textEscaped]: { match: Re(ee), order: 1, parse: (e) => ({ text: e[1], type: r.text }) },
            [r.textMarked]: { match: Re(K), order: 3, parse: Fe, render: (e, t, n) => d("mark", { key: n.key }, t(e.children, n)) },
            [r.textStrikethroughed]: { match: Re(Y), order: 3, parse: Fe, render: (e, t, n) => d("del", { key: n.key }, t(e.children, n)) },
          };
        ...
        return q.length
          ? d(
              ...
              d(
                ...
                { key: "footer" },
                q.map(function (e) {
                  return d("div", { id: i.slugify(e.identifier, ze), key: e.identifier }, e.identifier, ae(le(e.footnote, { inline: !0 })));
                })
              )
            )
          : ce;
              ...
              children: [
                (0, jsx_runtime.jsx)("p", {
                  ...
                  children: (0, jsx_runtime.jsx)(index_modern, {
                    children: translateString(lib_index_js_.TranslatableString.InvalidObjectField, [name || "root", err.message]),
                  }),
                }),
                (0, jsx_runtime.jsx)("pre", { children: JSON.stringify(schema) }),
              ],
            });
          }
              ...
              return {
                content: (0, jsx_runtime.jsx)(
                  SchemaField,
                  {
                    ...
                    schema: get_default()(schema, [lib_index_js_.PROPERTIES_KEY, name], {}),
        ...
        return componentName in fields
          ...
          : () => {
              ...
              return (0, jsx_runtime.jsx)(UnsupportedFieldTemplate, {
                schema: schema,
                idSchema: idSchema,
                reason: translateString(lib_index_js_.TranslatableString.UnknownFieldType, [String(schema.type)]),
                registry: registry,
              });
            };
      }
      ...
      function SchemaFieldRender(props) {
        ...
        const errorsComponent =
          hideError || ((schema.anyOf || schema.oneOf) && !schemaUtils.isSelect(schema))
            ? undefined
        ...
        const isReplacingAnyOrOneOf =
          (uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema["ui:field"]) &&
          (uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema["ui:fieldReplacesAnyOrOneOf"]) === true;
            ...
            children: [
              ...
              schema.anyOf &&
                ...
                (0, jsx_runtime.jsx)(_AnyOfField, {
                  ...
                  options: schema.anyOf.map((_schema) => schemaUtils.retrieveSchema(isObject_default()(_schema) ? _schema : {}, formData)),
                  registry: registry,
                  schema: schema,
                  uiSchema: uiSchema,
                }),
              schema.oneOf &&
                ...
                (0, jsx_runtime.jsx)(_OneOfField, {
                  ...
                  onChange: props.onChange,
                  onFocus: props.onFocus,
                  options: schema.oneOf.map((_schema) => schemaUtils.retrieveSchema(isObject_default()(_schema) ? _schema : {}, formData)),
                  registry: registry,
                  schema: schema,
                  uiSchema: uiSchema,
                }),
      ...
      function ArrayFieldItemTemplate(props) {
        ...
        return (0, jsx_runtime.jsxs)("div", {
          className: className,
          children: [
            (0, jsx_runtime.jsx)("div", { className: hasToolbar ? "col-xs-9" : "col-xs-12", children: children }),
            hasToolbar &&
              (0, jsx_runtime.jsx)("div", {
        ...
        return (0, jsx_runtime.jsxs)("fieldset", {
          ...
          children: [
            ...
            (0, jsx_runtime.jsx)("div", {
              ...
              children: items && items.map(({ key, ...itemProps }) => (0, jsx_runtime.jsx)(ArrayFieldItemTemplate, { ...itemProps }, key)),
            }),
            canAdd &&
      ...
      function BaseInputTemplate(props) {
        ...
        const _onChange = (0, index_js_.useCallback)(
          ({ target: { value } }) => onChange(value === "" ? options.emptyValue : value),
          [onChange, options]
        );
        ...
        return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [
            (0, jsx_runtime.jsx)("input", {
              ...
              value: inputValue,
              ...inputProps,
              list: schema.examples ? (0, lib_index_js_.examplesId)(id) : undefined,
              onChange: onChangeOverride || _onChange,
              onBlur: _onBlur,
              onFocus: _onFocus,
              "aria-describedby": (0, lib_index_js_.ariaDescribedByIds)(id, !!schema.examples),
            }),
      ...
      function IconButton(props) {
        ...
        return (0, jsx_runtime.jsx)("button", {
          ...
          ...otherProps,
          children: (0, jsx_runtime.jsx)("i", { className: `glyphicon glyphicon-${icon}` }),
        });
      }
      ...
      function MoveDownButton(props) {
        ...
        return (0, jsx_runtime.jsx)(IconButton, {
          title: translateString(lib_index_js_.TranslatableString.MoveDownButton),
        ...
        return (0, jsx_runtime.jsx)("div", {
          ...
          children: (0, jsx_runtime.jsx)("p", {
            ...
            children: (0, jsx_runtime.jsx)(IconButton, {
              ...
              title: translateString(lib_index_js_.TranslatableString.AddButton),
              onClick: onClick,
              disabled: disabled,
              registry: registry,
            }),
          ...
          children: [
            (0, jsx_runtime.jsx)("div", {
              ...
              children: (0, jsx_runtime.jsx)("h3", {
                ...
                children: translateString(lib_index_js_.TranslatableString.ErrorsLabel),
              }),
            }),
      ...
      function Label(props) {
        ...
        return (0, jsx_runtime.jsxs)("label", {
          ...
          htmlFor: id,
          children: [label, required && (0, jsx_runtime.jsx)("span", { className: "required", children: REQUIRED_FIELD_SYMBOL })],
        });
      ...
      function FieldTemplate(props) {
        ...
        return (0, jsx_runtime.jsxs)(WrapIfAdditionalTemplate, {
          ...props,
          children: [
            displayLabel && (0, jsx_runtime.jsx)(Label, { label: label, required: required, id: id }),
      ...
      /* harmony default export */ const templates_FieldTemplate = FieldTemplate; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/templates/FieldErrorTemplate.js
      //# sourceMappingURL=index.js.map
      ...
      function TitleField(props) {
        ...
        return (0, jsx_runtime.jsxs)("legend", {
          id: id,
          children: [title, required && (0, jsx_runtime.jsx)("span", { className: "required", children: TitleField_REQUIRED_FIELD_SYMBOL })],
        });
      ...
      function UnsupportedField(props) {
        ...
        return (0, jsx_runtime.jsxs)("div", {
          ...
          children: [
            (0, jsx_runtime.jsx)("p", {
              children: (0, jsx_runtime.jsx)(index_modern, { children: translateString(translateEnum, translateParams) }),
            }),
            schema && (0, jsx_runtime.jsx)("pre", { children: JSON.stringify(schema, null, 2) }),
          ],
        });
      }
      /* harmony default export */ const templates_UnsupportedField = UnsupportedField; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/templates/WrapIfAdditionalTemplate.js
      ...
      function WrapIfAdditionalTemplate(props) {
        const { id, classNames, style, disabled, label, onKeyChange, onDropPropertyClick, readonly, required, schema, children, uiSchema, registry } =
          props;
            ...
            children: [
              (0, jsx_runtime.jsx)("div", {
                ...
                children: (0, jsx_runtime.jsxs)("div", {
                  className: "form-group",
                  children: [
                    (0, jsx_runtime.jsx)(Label, { label: keyLabel, required: required, id: `${id}-key` }),
                    (0, jsx_runtime.jsx)("input", {
                      className: "form-control",
                      type: "text",
                      id: `${id}-key`,
              ...
              (0, jsx_runtime.jsx)("div", { className: "form-additional form-group col-xs-5", children: children }),
              (0, jsx_runtime.jsx)("div", {
                className: "col-xs-2",
            ...
            (options.hideNowButton !== "undefined" ? !options.hideNowButton : true) &&
              (0, jsx_runtime.jsx)("li", {
                ...
                children: (0, jsx_runtime.jsx)("a", {
                  ...
                  children: translateString(lib_index_js_.TranslatableString.NowLabel),
                }),
              }),
            (options.hideClearButton !== "undefined" ? !options.hideClearButton : true) &&
              (0, jsx_runtime.jsx)("li", {
                ...
                children: (0, jsx_runtime.jsx)("a", {
                  ...
                  onClick: handleClear,
                  children: translateString(lib_index_js_.TranslatableString.ClearLabel),
                }),
              }),
          ],
        });
      ...
      /* harmony default export */ const widgets_AltDateTimeWidget = AltDateTimeWidget; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/widgets/CheckboxWidget.js
          ...
          children: [
            ...
            (0, jsx_runtime.jsxs)("label", {
              children: [
                ...
                (0, lib_index_js_.labelValue)((0, jsx_runtime.jsx)("span", { children: label }), hideLabel),
              ],
            }),
          ],
        });
      }
      /* harmony default export */ const widgets_CheckboxWidget = CheckboxWidget; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/widgets/CheckboxesWidget.js
      ...
      function CheckboxesWidget({
        ...
        const handleBlur = (0, index_js_.useCallback)(
          ({ target: { value } }) => onBlur(id, (0, lib_index_js_.enumOptionsValueForIndex)(value, enumOptions, emptyValue)),
          [onBlur, id]
        );
        const handleFocus = (0, index_js_.useCallback)(
          ({ target: { value } }) => onFocus(id, (0, lib_index_js_.enumOptionsValueForIndex)(value, enumOptions, emptyValue)),
          [onFocus, id]
        );
        return (0, jsx_runtime.jsx)("div", {
          ...
          children:
            ...
            enumOptions.map((option, index) => {
              ...
              return inline
                ? (0, jsx_runtime.jsx)("label", { className: `checkbox-inline ${disabledCls}`, children: checkbox }, index)
                : (0, jsx_runtime.jsx)(
                    "div",
                    { className: `checkbox ${disabledCls}`, children: (0, jsx_runtime.jsx)("label", { children: checkbox }) },
                    index
                  );
            }),
        });
      }
      /* harmony default export */ const widgets_CheckboxesWidget = CheckboxesWidget; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/widgets/ColorWidget.js
        ...
        return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [
            ...
            (0, jsx_runtime.jsx)("a", {
              ...
              children: translateString(lib_index_js_.TranslatableString.PreviewLabel),
            }),
          ],
        });
      }
              ...
              "li",
              {
                children: [
                  (0, jsx_runtime.jsx)(index_modern, {
                    children: translateString(lib_index_js_.TranslatableString.FilesInfo, [name, type, String(size)]),
                  }),
                  preview && (0, jsx_runtime.jsx)(FileInfoPreview, { fileInfo: fileInfo, registry: registry }),
                ],
              },
              key
            );
      ...
      function FileWidget(props) {
        ...
        return (0, jsx_runtime.jsxs)("div", {
          children: [
            ...
            (0, jsx_runtime.jsx)(FilesInfo, { filesInfo: filesInfo, registry: registry, preview: options.filePreview }),
          ],
        });
      }
        ...
        return (0, jsx_runtime.jsx)("div", {
          ...
          children:
            ...
            enumOptions.map((option, i) => {
              ...
              return inline
                ? (0, jsx_runtime.jsx)("label", { className: `radio-inline ${disabledCls}`, children: radio }, i)
                : (0, jsx_runtime.jsx)("div", { className: `radio ${disabledCls}`, children: (0, jsx_runtime.jsx)("label", { children: radio }) }, i);
            }),
        });
      }
      ...
      function RangeWidget(props) {
        ...
        return (0, jsx_runtime.jsxs)("div", {
          ...
          children: [
            (0, jsx_runtime.jsx)(BaseInputTemplate, { type: "range", ...props }),
            (0, jsx_runtime.jsx)("span", { className: "range-view", children: value }),
          ],
        });
      ...
      function SelectWidget({
        ...
        return (0, jsx_runtime.jsxs)("select", {
          ...
          "aria-describedby": (0, lib_index_js_.ariaDescribedByIds)(id),
          children: [
            !multiple && schema.default === undefined && (0, jsx_runtime.jsx)("option", { value: "", children: placeholder }),
            Array.isArray(enumOptions) &&
      ...
      /* harmony default export */ const widgets_TextareaWidget = TextareaWidget; // CONCATENATED MODULE: ../node_modules/@rjsf/core/lib/components/widgets/TextWidget.js
      ...
      class Form_Form extends index_js_.Component {
        ...
        constructor(props) {
          ...
          this.onChange = (formData, newErrorSchema, id) => {
            ...
            if (mustValidate) {
              ...
              const errorSchema = extraErrors ? (0, lib_index_js_.mergeObjects)(newErrorSchema, extraErrors, "preventDuplicates") : newErrorSchema;
              state = {
                formData: newFormData,
                errorSchema: errorSchema,
        ...
        componentDidUpdate(_, prevState, snapshot) {
          if (snapshot.shouldUpdate) {
            ...
            if (
              !(0, lib_index_js_.deepEquals)(nextState.formData, this.props.formData) &&
        ...
        getStateFromProps(props, inputFormData, retrievedSchema) {
          ...
          const _retrievedSchema =
            retrievedSchema !== null && retrievedSchema !== void 0 ? retrievedSchema : schemaUtils.retrieveSchema(schema, formData);
        ...
        render() {
          ...
          return (0, jsx_runtime.jsxs)(FormTag, {
            ...
            children: [
              ...
              children ? children : (0, jsx_runtime.jsx)(SubmitButton, { uiSchema: submitUiSchema, registry: registry }),
      ...
      function withTheme(themeProps) {
        return forwardRef(({ fields, widgets, templates, ...directProps }, ref) => {
          ...
          templates = {
            ...
            ...templates,
            ButtonTemplates: {
              ...((_a = themeProps === null || themeProps === void 0 ? void 0 : themeProps.templates) === null || _a === void 0
                ? void 0
                : _a.ButtonTemplates),
    ...
    /***/ 8843: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
    ...
    /***/ 63005: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 10228: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 14648: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 43551: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 37634: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      "use strict";
    ...
    /***/ 73062: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      "use strict";
      var __webpack_unused_export__;
    ...
    /***/ 53861: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      "use strict";
