(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [9799, 7061],
  {
    /***/ 56318: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
...
*/
      function ifNotIn(nodes, source) {
        return (context) => {
          for (
            let pos = (0, _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.syntaxTree)(context.state).resolveInner(context.pos, -1);
            pos;
            pos = pos.parent
          ) {
...
*/
      ...
      class FuzzyMatcher {
        constructor(pattern) {
          ...
          for (let p = 0; p < pattern.length; ) {
            let char = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(pattern, p),
              size = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(char);
        ...
        match(word) {
          ...
          if (chars.length == 1) {
            let first = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(word, 0),
              firstSize = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(first);
                ...
                next < 0xff
                  ? (next >= 48 && next <= 57) || (next >= 97 && next <= 122)
                    ...
                    : next >= 65 && next <= 90
                      ? 1 /* Tp.Upper */
                      : 0 /* Tp.NonWord */
                  : (ch = (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.fromCodePoint)(next)) != ch.toLowerCase()
                    ? 1 /* Tp.Upper */
                    : ch != ch.toUpperCase()
                      ? 2 /* Tp.Lower */
                      : 0; /* Tp.NonWord */
          ...
          if (adjacentTo == len && adjacentStart == 0)
            return this.ret(-200 /* Penalty.CaseFold */ - word.length + (adjacentEnd == word.length ? 0 : -100) /* Penalty.NotFull */, [
              0,
              adjacentEnd,
            ]);
            ...
            let to =
              ...
              (this.astral
                ? (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(
                    (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(word, pos)
                  )
                : 1);
      ...
      function defaultPositionInfo(view, list, option, info, space, tooltip) {
        let rtl = view.textDirection == _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Direction.RTL,
          left = rtl,
          narrow = false;
        let side = "top",
          offset,
      ...
      class ActiveResult extends ActiveSource {
        ...
        updateFor(tr, type) {
          ...
          if (pos > to || !result || (type & 2 /* UpdateType.Backspacing */ && (cur(tr.startState) == this.from || pos < this.limit)))
...
*/
      ...
      const MaxUpdateCount = 50,
        MinAbortTime = 1000;
      const completionPlugin = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.ViewPlugin.fromClass(
        class {
          constructor(view) {
            this.view = view;
      ...
      const commitCharacters = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
        ...
        instantiate(state, pos) {
          ...
          for (let line of this.lines) {
            if (text.length) {
              ...
              for (let i = 0; i < tabs; i++) indent += state.facet(_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.indentUnit);
      ...
      let fieldMarker = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.widget({
      ...
      class ActiveSnippet {
        constructor(ranges, active) {
          this.ranges = ranges;
          this.active = active;
          this.deco = _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.set(
      ...
      const snippetState = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateField.define({
        ...
        provide: (f) =>
          _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.decorations.from(f, (val) =>
            val ? val.deco : _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.none
          ),
      });
      function fieldSelection(ranges, field) {
        return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.create(
          ranges.filter((r) => r.field == field).map((r) => _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(r.from, r.to))
        );
      }
      /**
        ...
        return (editor, completion, from, to) => {
          ...
          let spec = {
            ...
            annotations: completion
              ? [pickedCompletion.of(completion), _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Transaction.userEvent.of("input.complete")]
              : undefined,
          };
...
*/
      ...
      const addSnippetKeymap = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.keymap.compute([snippetKeymap], (state) => state.facet(snippetKeymap))
      );
      /**
...
*/
      ...
      const inputHandler = /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.inputHandler.of((view, from, to, insert) => {
        ...
        if (
          ...
          (insert.length == 2 &&
            (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(
              (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(insert, 0)
            ) == 1) ||
          from != sel.from ||
          to != sel.to
        )
          ...
          changes = state.changeByRange((range) => {
            if (range.empty) {
              ...
              for (let token of tokens) {
                if (
                  token == before &&
                  nextChar(state.doc, range.head) == closing((0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(token, 0))
                )
                  return {
...
*/
      ...
      function nextChar(doc, pos) {
        ...
        return next.slice(
          0,
          (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)((0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(next, 0))
        );
      }
      function prevChar(doc, pos) {
        let prev = doc.sliceString(pos - 2, pos);
        return (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(
          (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(prev, 0)
        ) == prev.length
          ? prev
          : prev.slice(1);
      }
      ...
      function canStartStringAt(state, pos, prefixes) {
        ...
        if (charCat(state.sliceDoc(pos - 1, pos)) != _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word) return pos;
        for (let prefix of prefixes) {
          let start = pos - prefix.length;
          if (
            state.sliceDoc(start, pos) == prefix &&
            charCat(state.sliceDoc(start - 1, start)) != _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word
          )
            return start;
        }
        return -1;
...
*/
      ...
      const completionKeymapExt = /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.keymap.computeN([completionConfig], (state) =>
...
*/
    ...
    /***/ 49906: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    */
      ...
      class Parse {
        constructor(parser, input, fragments, ranges) {
          ...
          this.fragments =
            fragments.length && this.stream.end - from > parser.bufferLength * 4 ? new FragmentCursor(fragments, parser.nodeSet) : null;
        }
        get parsedPos() {
        ...
        advance() {
          ...
          if (this.recovering && stopped) {
            let finished =
              this.stoppedAt != null && stopped[0].pos > this.stoppedAt ? stopped[0] : this.runRecovery(stopped, stoppedTokens, newStacks);
            if (finished) {
          ...
          if (this.fragments) {
            ...
            for (let cached = this.fragments.nodeAt(start); cached; ) {
              ...
              if (
                match > -1 &&
                cached.length &&
                (!strictCx || (cached.prop(_lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeProp.contextHash) || 0) == cxHash)
              ) {
            ...
            if (verbose)
              console.log(
                base +
                  ...
                  ` (via ${
                    (action & 65536) /* Action.ReduceFlag */ == 0 ? "shift" : `reduce of ${parser.getName(action & 65535 /* Action.ValueMask */)}`
