...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7302, 3768],
  {
    /***/ 83768: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var react_index_js_default = /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ../packages/tree-extension/lib/fileactions.js
      ...
      class FilesActionButtons {
        ...
        constructor(options) {
          ...
          const placeholder = index_js_.ReactWidget.create(
            react_index_js_default().createElement("div", { key: "placeholder" }, trans.__("Select items to perform actions on them."))
          );
          ...
          actions.forEach((action) => {
            const widget = index_js_.ReactWidget.create(
              react_index_js_default().createElement(index_js_.CommandToolbarButtonComponent, {
                key: action,
                commands: commands,
      ...
      const createNew = {
        ...
        activate: (app, translator, toolbarRegistry) => {
          ...
          const populateNewMenu = () => {
            ...
            const specs =
              (_b = (_a = serviceManager.kernelspecs) === null || _a === void 0 ? void 0 : _a.specs) === null || _b === void 0
                ? void 0
                : _b.kernelspecs;
            ...
            const baseCommands = ["terminal:create-new", "console:create", "filebrowser:create-new-file", "filebrowser:create-new-directory"];
      ...
      const fileActions = {
        ...
        activate: (app, browser, toolbarRegistry, translator) => {
          ...
          const methods = ["_selectItem", "_handleMultiSelect", "handleFileSelect"];
      ...
      const notebookTreeWidget = {
        ...
        activate: (app, browser, translator, settingRegistry, toolbarRegistry, factory, manager, settingEditorTracker, jsonSettingEditorTracker) => {
          ...
          (0, index_js_.setToolbar)(
            browser,
            (0, index_js_.createToolbarFactory)(toolbarRegistry, settingRegistry, FILE_BROWSER_FACTORY, notebookTreeWidget.id, translator)
          );
          if (manager) {
       ...
       */
      const plugins = [createNew, fileActions, fileBrowserSettings, fileFilterCommand, loadPlugins, openFileBrowser, notebookTreeWidget];
