(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7957, 7061],
  {
    /***/ 79504: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
    ...
    /***/ 38828: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      const equalityFlat = (a, b) =>
        ...
        (a != null &&
          ...
          ((array.isArray(a) && array.equalFlat(a, /** @type {Array<T>} */ (b))) || (typeof a === "object" && object.equalFlat(a, b))));
    ...
    /***/ 22592: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 36498: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
       ...
       */
      const equalFlat = (a, b) =>
        a === b || (length(a) === length(b) && every(a, (val, key) => (val !== undefined || hasProperty(b, key)) && b[key] === val));

      /***/
    },

    /***/ 12330: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      class Observable {
        ...
        on(name, f) {
          _map_js__WEBPACK_IMPORTED_MODULE_0__ /* .setIfUndefined */
            .Yu(this._observers, name, _set_js__WEBPACK_IMPORTED_MODULE_1__ /* .create */.Ue)
            .add(f);
        }
    ...
    /***/ 79287: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Ue: () => /* binding */ create,
        /* harmony export */
    ...
    /***/ 67957: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      // ESM COMPAT FLAG
      ...
      const supportsColor =
        ...
        (!isNode || hasParam("color") || forceColor || getVariable("COLORTERM") !== null || (getVariable("TERM") || "").includes("color")); // CONCATENATED MODULE: ../node_modules/lib0/buffer.js
      /* c8 ignore stop */
       ...
       * @return {string}
       */
      const uuidv4 = () => uuidv4Template.replace(/[018]/g, /** @param {number} c */ (c) => (c ^ (uint32() & (15 >> (c / 4)))).toString(16)); // CONCATENATED MODULE: ../node_modules/lib0/promise.js
       ...
       * @return {Element}
       */
      const dom_element = (name, attrs = [], children = []) => append(setAttributes(createElement(name), attrs), children);
      ...
      const createModuleLogger = (_print, moduleName) => {
        ...
        const doLogging =
          debugRegexVar !== null && (debugRegexVar === "*" || debugRegexVar === "true" || new RegExp(debugRegexVar, "gi").test(moduleName));
        ...
        return !doLogging
          ...
          : (...args) => {
              ...
              _print(
                ...
                moduleName,
                UNCOLOR,
                ...args.map((arg) => (typeof arg === "string" || typeof arg === "symbol" ? arg : JSON.stringify(arg))),
                color,
                " +" + timeDiff + "ms"
              );
            };
        ...
        group(args, collapsed = false) {
          eventloop.enqueue(() => {
            const triangleDown = dom.element(
              "span",
              [pair.create("hidden", collapsed), pair.create("style", "color:grey;font-size:120%;")],
              [dom.text("▼")]
            );
            const triangleRight = dom.element(
              "span",
              [pair.create("hidden", !collapsed), pair.create("style", "color:grey;font-size:125%;")],
              [dom.text("▶")]
            );
            const content = dom.element(
              "div",
              [pair.create("style", `${lineStyle};padding-left:${this.depth * 10}px`)],
              [triangleDown, triangleRight, dom.text(" ")].concat(_computeLineSpans(args))
            );
        ...
        print(args) {
          eventloop.enqueue(() => {
            dom.append(this.ccontainer, [
              dom.element("div", [pair.create("style", `${lineStyle};padding-left:${this.depth * 10}px`)], _computeLineSpans(args)),
            ]);
          });
        }
       ...
       * @return {function(...any):void}
       */
      const logging_createModuleLogger = (moduleName) => common.createModuleLogger(print, moduleName); // CONCATENATED MODULE: ../node_modules/lib0/iterator.js
        ...
        while (true) {
          if (stackHead.constructor !== Skip) {
            const localClock = map /* setIfUndefined */
              .Yu(state, stackHead.id.client, () => getState(store, stackHead.id.client));
      ...
      class PermanentUserData {
        ...
        constructor(doc, storeType = doc.getMap("users")) {
          ...
          const initUser = (user, userDescription) => {
            ...
            ids.observe(
              /** @param {YArrayEvent<any>} event */ (event) => event.changes.added.forEach((item) => item.content.getContent().forEach(addClientId))
            );
      ...
      const splitSnapshotAffectedStructs = (transaction, snapshot) => {
        const meta = map /* setIfUndefined */
          .Yu(transaction.meta, splitSnapshotAffectedStructs, lib0_set /* create */.Ue);
      ...
      const writeUpdateMessageFromTransaction = (encoder, transaction) => {
        if (
          ...
          !map /* any */
            .Yj(transaction.afterState, (clock, client) => transaction.beforeState.get(client) !== clock)
        ) {
          return false;
        }
        ...
        ds.clients.forEach((deleteItems, client) => {
          ...
          for (let di = deleteItems.length - 1; di >= 0; di--) {
            ...
            const mostRightIndexToCheck = lib0_math /* min */
              .VV(structs.length - 1, 1 + findIndexSS(structs, deleteItem.clock + deleteItem.len - 1));
          ...
          (transaction) => {
            while (stack.length > 0 && result === null) {
              ...
              itemsToRedo.forEach((struct) => {
                performedChange =
                  redoItem(transaction, struct, itemsToRedo, stackItem.insertions, undoManager.ignoreRemoteMapChanges, undoManager) !== null ||
                  performedChange;
              });
      ...
      const typeMapSet = (transaction, parent, key, value) => {
        ...
        new Item(createID(ownClientId, getState(doc.store, ownClientId)), left, left && left.lastId, null, null, parent, key, content).integrate(
          transaction,
          0
        );
      };
      ...
      class YArray extends AbstractType {
        ...
        clone() {
          ...
          arr.insert(
            0,
            this.toArray().map((el) => (el instanceof AbstractType ? /** @type {typeof el} */ (el.clone()) : el))
          );
          return arr;
        }
      ...
      const formatText = (transaction, parent, currPos, length, attributes) => {
        ...
        iterationLoop: while (
          currPos.right !== null &&
          (length > 0 || (negatedAttributes.size > 0 && (currPos.right.deleted || currPos.right.content.constructor === ContentFormat)))
        ) {
          if (!currPos.right.deleted) {
            ...
            transact(this.doc, (transaction) => {
              ...
              for (let i = 0; i < delta.length; i++) {
                ...
                if (op.insert !== undefined) {
                  ...
                  const ins =
                    !sanitize && typeof op.insert === "string" && i === delta.length - 1 && currPos.right === null && op.insert.slice(-1) === "\n"
                      ? op.insert.slice(0, -1)
                      : op.insert;
      ...
      class YXmlFragment extends AbstractType {
        ...
        querySelectorAll(query) {
          ...
          return lib0_array /* from */
            .Dp(new YXmlTreeWalker(this, (element) => element.nodeName && element.nodeName.toUpperCase() === query));
        }
      ...
      const isDeletedByUndoStack = (stack, id) =>
        lib0_array /* some */
          .G(stack, /** @param {StackItem} s */ (s) => isDeleted(s.deletions, id));
      ...
      const redoItem = (transaction, item, redoitems, itemsToDelete, ignoreRemoteMapChanges, um) => {
        ...
        if (parentItem !== null && parentItem.deleted === true) {
          ...
          if (
            ...
            (!redoitems.has(parentItem) || redoItem(transaction, parentItem, redoitems, itemsToDelete, ignoreRemoteMapChanges, um) === null)
          ) {
            return null;
          }
        ...
        const parentType =
          parentItem === null ? /** @type {AbstractType<any>} */ (item.parent) : /** @type {ContentType} */ (parentItem.content).type;
      ...
      class Item extends AbstractStruct {
        ...
        integrate(transaction, offset) {
          ...
          if (this.parent) {
            ...
            if (
              /** @type {AbstractType<any>} */ (this.parent._item !== null && /** @type {AbstractType<any>} */ (this.parent)._item.deleted) ||
