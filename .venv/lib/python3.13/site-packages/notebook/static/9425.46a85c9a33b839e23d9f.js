...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [9425],
  {
    /***/ 49425: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function clike(parserConfig) {
        ...
        return {
          ...
          indent: function (state, textAfter, context) {
            ...
            return (
              ctx.indented + (closing ? 0 : context.unit) + (!closing && switchBlock && !/^(?:case|default)\b/.test(textAfter) ? context.unit : 0)
            );
          },
