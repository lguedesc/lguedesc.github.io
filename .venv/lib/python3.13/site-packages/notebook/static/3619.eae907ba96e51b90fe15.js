...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [3619],
  {
    /***/ 83619: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      /* harmony default export */ function transition_attr(name, value) {
        var fullname = namespace(name),
          i = fullname === "transform" ? transform /* interpolateTransformSvg */.w : transition_interpolate;
      ...
      /* harmony default export */ function transition_selectAll(select) {
        ...
        for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
          for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) {
            if ((node = group[i])) {
              for (
                var children = select.call(node, node.__data__, i, group), child, inherit = get(node, id), k = 0, l = children.length;
                k < l;
                ++k
              ) {
                if ((child = children[k])) {
      ...
      /* harmony default export */ function transition_style(name, value, priority) {
        ...
        return value == null
          ...
          : typeof value === "function"
            ? this.styleTween(name, style_styleFunction(name, i, tweenValue(this, "style." + name, value))).each(styleMaybeRemove(this._id, name))
      ...
      /* harmony default export */ function transition_text(value) {
        return this.tween(
          "text",
          typeof value === "function" ? text_textFunction(tweenValue(this, "text", value)) : text_textConstant(value == null ? "" : value + "")
        );
        ...
        function started(event) {
          ...
          if (type === "overlay") {
            ...
            state.selection = selection = [
              [(w0 = dim === Y ? W : brush_min(pts[0][0], pts[1][0])), (n0 = dim === X ? N : brush_min(pts[0][1], pts[1][1]))],
              [(e0 = dim === Y ? E : brush_max(pts[0][0], pts[1][0])), (s0 = dim === X ? S : brush_max(pts[0][1], pts[1][1]))],
            ];
      ...
      /* harmony default export */ const Tableau10 = (0, colors /* default */.Z)("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"); // CONCATENATED MODULE: ../node_modules/d3-scale-chromatic/src/index.js
      ...
      var defaultLocale = __webpack_require__(94031); // CONCATENATED MODULE: ../node_modules/d3-time-format/src/index.js
      ...
      /* harmony default export */ function zoom() {
        ...
        function mousedowned(event, ...args) {
          ...
          function mousemoved(event) {
            ...
            g.event(event).zoom(
              "mouse",
              constrain(translate(g.that.__zoom, (g.mouse[0] = pointer(event, currentTarget)), g.mouse[1]), g.extent, translateExtent)
            );
          }
