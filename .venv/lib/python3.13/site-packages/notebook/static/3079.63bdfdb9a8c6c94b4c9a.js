...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [3079],
  {
    /***/ 33079: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        parse(tokens, top = true) {
          ...
          for (let i = 0; i < tokens.length; i++) {
            ...
            if (this.options.extensions?.renderers?.[anyToken.type]) {
              ...
              if (
                ret !== false ||
                !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(genericToken.type)
              ) {
                out += ret || "";
                continue;
              }
