    ...
    79311: (e, t, n) => {
      ...
      for (let Lt = 1, bt; (bt = f[Lt]); Lt++) {
        Q[Lt] = o.NodeType.define({
          id: Lt,
          name: bt,
          props: Lt >= f.Escape ? [] : [[o.NodeProp.group, Lt in p ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
          top: bt == "Document",
        });
      }
      const Z = [];
      ...
      const Ue = me.configure({
        props: [
          i.foldNodeProp.add((e) =>
            !e.is("Block") || e.is("Document") || Qe(e) != null || Ze(e) ? undefined : (e, t) => ({ from: t.doc.lineAt(e.from).to, to: e.to })
          ),
          qe.add(Qe),
      ...
      const Je = Ke(Ue);
      const We = Ue.configure([Xe, $e, De, _e, { props: [i.foldNodeProp.add({ Table: (e, t) => ({ from: t.doc.lineAt(e.from).to, to: e.to }) })] }]);
      const Ye = Ke(We);
      function et(e, t) {
        return (n) => {
          if (n && e) {
      ...
      function ht(e, t, n) {
        ...
        for (let i = 0, l = e.length - 2; i <= l; i++) {
          s += e[i].blank(i < l ? (0, r.countColumn)(n.text, 4, Math.min(n.text.length, e[i + 1].from)) - s.length : null, i < l);
        }
        return it(s, t);
      }
      function ft(e, t) {
