    ...
    48313: (t, e, n) => {
      ...
      function me(t, e, n, i, s) {
        for (let r of e) {
          ...
          let o = e <= n && s > n && pe(t, r.tree, 0 - r.offset, n, s),
            a;
          if (o && o.pos <= i && (a = ge(t, r.tree, n + r.offset, o.pos + r.offset, false))) return { state: o.state, tree: a };
        }
      ...
      class ke {
        constructor(t, e, n, r) {
          ...
          if (i && this.parsedPos < i.viewport.from - 1e5 && r.some((t) => t.from <= i.viewport.from && t.to >= i.viewport.from)) {
        ...
        emitToken(t, e, n, r) {
          ...
          if (this.lang.streamParser.mergeTokens && i == 4 && s >= 0 && this.chunk[s] == t && this.chunk[s + 2] == e) this.chunk[s + 2] = n;
        ...
        parseLine(t) {
          ...
          if (s.eol()) {
            ...
            while (!s.eol()) {
              ...
              if (t) r = this.emitToken(this.lang.tokenTable.resolve(t), this.parsedPos + s.start, this.parsedPos + s.pos, r);
      ...
      function Ie(t, e) {
        let n = r.NodeType.define({ id: be.length, name: "Document", props: [p.add(() => t), z.add(() => (t) => e.getIndent(t))], top: true });
        be.push(n);
        return n;
      }
      function Ne(t) {
