    ...
    46492: (e, t, a) => {
      ...
      function F(e) {
        return new o.Lu((t) => {
          ...
          if (A(n, E)) {
          ...
          } else if (e.plsqlQuotingMechanism && (n == 113 || n == 81) && t.next == 39 && t.peek(1) > 0 && !A(t.peek(1), E)) {
            let e = t.peek(1);
            t.advance(2);
            L(t, e);
            t.acceptToken(m);
            ...
            t.acceptToken(t.next == 46 || t.peek(-i.length - 1) == 46 ? S : (a = e.words[i.toLowerCase()]) !== null && a !== void 0 ? a : S);
          }
        });
      }
      const H = F(Y);
      ...
      class me {
        ...
        child(e) {
          ...
          let a = t[e];
          if (a) return a;
          if (e && !this.list.some((t) => t.label == e)) this.list.push(pe(e, "type", this.idQuote, this.idCaseInsensitive));
        ...
        addCompletions(e) {
          for (let t of e) this.addCompletion(typeof t == "string" ? pe(t, "property", this.idQuote, this.idCaseInsensitive) : t);
        }
        addNamespace(e) {
          if (Array.isArray(e)) {
      ...
      function fe(e, t, a, n, i, r) {
        var s;
        let o = ((s = r === null || r === void 0 ? void 0 : r.spec.identifierQuotes) === null || s === void 0 ? void 0 : s[0]) || '"';
      ...
      function he(e, t, a) {
        ...
        return (0, l.Ar)(["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", "."], (0, l.et)(n));
      }
      let be = J.configure({
        props: [
      ...
      function ke(e) {
        return e.schema ? fe(e.schema, e.tables, e.schemas, e.defaultTable, e.defaultSchema, e.dialect || we) : () => null;
      }
      function xe(e) {
      ...
      function Oe(e = {}) {
        let t = e.dialect || we;
        return new n.LanguageSupport(t.language, [xe(e), t.language.data.of({ autocomplete: ye(t, e.upperCaseKeywords, e.keywordCompletion) })]);
      }
      const we = _e.define({});
      const Qe = _e.define({
        charSetCasts: true,
      ...
      const qe = "charset clear edit ego help nopager notee nowarning pager print prompt quit rehash source status system tee";
      const Pe = _e.define({
        operatorChars: "*+-%<>!=&|^",
        charSetCasts: true,
