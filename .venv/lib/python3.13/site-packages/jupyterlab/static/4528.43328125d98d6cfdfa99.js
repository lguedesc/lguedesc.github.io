      ...
      function s(e) {
        ...
        return {
          ...
          startState: function (e) {
            return { tokenize: null, context: new r(-e, 0, "top", null, false), indented: 0, startOfLine: true, prevToken: null };
          },
          token: function (t, n) {
            var r = n.context;
            if (t.sol()) {
            ...
            if (N == ";" || N == ":" || (N == "," && t.match(/^\s*(?:\/\/.*)?$/, false))) while (n.context.type == "statement") i(n);
            ...
            else if (g && (((r.type == "}" || r.type == "top") && N != ";") || (r.type == "statement" && N == "newstatement"))) {
              a(n, t.column(), "statement", t.current());
            }
            if (s == "variable" && (n.prevToken == "def" || (e.typeFirstDefinitions && o(t, n, t.start) && l(n.context) && t.match(/^\s*\(/, false))))
              s = "def";
            if (h.token) {
              var c = h.token(t, n, s);
              if (c !== undefined) s = c;
      ...
      const z = s({
        ...
        hooks: {
          ...
          token: function (e, t, n) {
            if (n == "variable" && e.peek() == "(" && (t.prevToken == ";" || t.prevToken == null || t.prevToken == "}") && N(e.current()))
              return "def";
          },
        },
        namespaceSeparator: "::",
