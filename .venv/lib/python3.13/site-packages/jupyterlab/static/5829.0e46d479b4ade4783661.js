    ...
    67097: (e, t, r) => {
      ...
      class O extends s.Component {
        ...
        renderArrayFieldItem(e) {
          ...
          const { disabled: v, hideError: b, idPrefix: C, idSeparator: k, readonly: F, uiSchema: j, registry: T, formContext: O } = this.props;
          const {
      ...
      class _ extends s.Component {
        ...
        render() {
          ...
          const { widget: b = "select", placeholder: C, autofocus: k, autocomplete: F, title: j = u.title, ...T } = (0, i.getUiOptions)(h, g);
            ...
            return {
              items: o.map(function (e, r) {
                ...
                const h = n.inline,
                  m = n.list;
                let p;
                (n.list = !0), u ? ((n.inline = !1), (p = c.replace(Ve, "\n\n"))) : ((n.inline = !0), (p = c.replace(Ve, "")));
                const f = t(p, n);
      ...
      function ht(e, t, r, n) {
        ...
        let i = e
          ...
          .reduce(
            (e, s) => (
              "|" === s.trim() ? e.push(n ? { type: L.tableSeparator } : { type: L.text, text: s }) : "" !== s && e.push.apply(e, t(s, r)), e
            ),
            []
          );
        r.inTable = s;
        ...
        return (
          i.forEach(function (e, t) {
            e.type === L.tableSeparator
              ...
              : (e.type !== L.text || (null != i[t + 1] && i[t + 1].type !== L.tableSeparator) || (e.text = e.text.trimEnd()),
                a[a.length - 1].push(e));
          }),
          a
        );
      ...
      function mt(e, t, r) {
        ...
        return (r.inline = !1), s.length ? { align: n, cells: s, header: i, type: L.table } : { children: i, type: L.paragraph };
      }
      function pt(e, t) {
      ...
      function Et(e = "", t = {}) {
        function r(e, r, ...n) {
          ...
          return t.createElement(
            (function (e, t) {
              const r = Dt(t, e);
              return r ? ("function" == typeof r || ("object" == typeof r && "render" in r) ? r : Dt(t, `${e}.component`, e)) : e;
            })(e, t.overrides),
          ...
          return i
            ? i.reduce(function (r, i, a) {
                ...
                if (-1 !== o) {
                  ...
                  "string" == typeof u && (he.test(u) || ge.test(u)) && (r[d] = s.cloneElement(n(u.trim()), { key: a }));
        ...
        const a = [],
          ...
          l = {
            ...
            [L.codeBlock]: {
              ...
              render: (e, t, n) => r("pre", { key: n.key }, r("code", P({}, e.attrs, { className: e.lang ? `lang-${e.lang}` : "" }), e.text)),
            },
            [L.codeFenced]: {
              match: yt(X),
              order: 0,
            ...
            [L.codeInline]: { match: gt(te), order: 3, parse: (e) => ({ text: e[2] }), render: (e, t, n) => r("code", { key: n.key }, e.text) },
            [L.footnote]: { match: yt(se), order: 0, parse: (e) => (a.push({ footnote: e[2], identifier: e[1] }), {}), render: Ot },
            [L.footnoteReference]: {
              match: ft(ie),
              order: 1,
              parse: (e) => ({ target: `#${t.slugify(e[1], dt)}`, text: e[1] }),
              render: (e, n, s) => r("a", { key: s.key, href: t.sanitizer(e.target, "a", "href") }, r("sup", { key: s.key }, e.text)),
            },
            [L.gfmTask]: {
              match: ft(le),
              order: 1,
            ...
            [L.htmlBlock]: {
              ...
              parse(e, t, r) {
                ...
                return (r.inAnchor = r.inAnchor || "a" === c), d ? (h.text = e[3]) : (h.children = o(t, a, r)), (r.inAnchor = !1), h;
              },
            ...
            [L.image]: {
              ...
              render: (e, n, s) => r("img", { key: s.key, alt: e.alt || void 0, title: e.title || void 0, src: t.sanitizer(e.target, "img", "src") }),
            },
            [L.link]: {
              match: ft(at),
              order: 3,
              parse: (e, t, r) => ({ children: kt(t, e[1], r), target: bt(e[2]), title: e[3] }),
              render: (e, n, s) => r("a", { key: s.key, href: t.sanitizer(e.target, "a", "href"), title: e.title }, n(e.children, s)),
            },
            ...
            [L.linkMailtoDetector]: {
              ...
              parse(e) {
                let t = e[1],
                  r = e[1];
                return Y.test(r) || (r = "mailto:" + r), { children: [{ text: t.replace("mailto:", ""), type: L.text }], target: r, type: L.link };
              },
            },
            [L.orderedList]: it(r, 1),
            [L.unorderedList]: it(r, 2),
            [L.newlineCoalescer]: { match: yt(re), order: 3, parse: Tt, render: () => "\n" },
            [L.paragraph]: { match: xt, order: 3, parse: jt, render: (e, t, n) => r("p", { key: n.key }, t(e.children, n)) },
            [L.ref]: { match: ft(ke), order: 0, parse: (e) => ((o[e[1]] = { target: e[2], title: e[4] }), {}), render: Ot },
            [L.refImage]: {
              match: gt(Fe),
              order: 0,
              parse: (e) => ({ alt: e[1] || void 0, ref: e[2] }),
              render: (e, n, s) =>
                o[e.ref] ? r("img", { key: s.key, alt: e.alt, src: t.sanitizer(o[e.ref].target, "img", "src"), title: o[e.ref].title }) : null,
            },
            [L.refLink]: {
              match: ft(je),
              order: 0,
              parse: (e, t, r) => ({ children: t(e[1], r), fallbackChildren: t(e[0].replace(Te, "\\$1"), r), ref: e[2] }),
              render: (e, n, s) =>
                o[e.ref]
                  ? r("a", { key: s.key, href: t.sanitizer(o[e.ref].target, "a", "href"), title: o[e.ref].title }, n(e.children, s))
            ...
            [L.text]: {
              match: St(Pe),
              order: 4,
              parse: (e) => ({ text: e[0].replace(me, (e, r) => (t.namedCodesToUnicode[r] ? t.namedCodesToUnicode[r] : e)) }),
              render: (e) => e.text,
            },
            [L.textBolded]: {
              match: gt(Ne),
            ...
            [L.textMarked]: { match: gt(Be), order: 3, parse: jt, render: (e, t, n) => r("mark", { key: n.key }, t(e.children, n)) },
            [L.textStrikethroughed]: { match: gt($e), order: 3, parse: jt, render: (e, t, n) => r("del", { key: n.key }, t(e.children, n)) },
          };
        ...
        return a.length
          ? r(
              ...
              r(
                ...
                { key: "footer" },
                a.map(function (e) {
                  return r("div", { id: t.slugify(e.identifier, dt), key: e.identifier }, e.identifier, d(c(e.footnote, { inline: !0 })));
                })
              )
            )
          : h;
            ...
            return (0, n.jsxs)("div", {
              children: [
                (0, n.jsx)("p", {
                  ...
                  style: { color: "red" },
                  children: (0, n.jsx)(It, { children: F(i.TranslatableString.InvalidObjectField, [u || "root", U.message]) }),
                }),
      ...
      function qt(e) {
        ...
        const J = (0, n.jsx)(j, { help: Y, idSchema: D, schema: O, uiSchema: a, hasErrors: !B && P && P.length > 0, registry: g });
        const Z =
          B || ((O.anyOf || O.oneOf) && !v.isSelect(O))
            ? undefined
            : (0, n.jsx)(T, { errors: P, errorSchema: l, idSchema: D, schema: O, uiSchema: a, registry: g });
        const Q = {
          description: (0, n.jsx)(F, { id: (0, i.descriptionId)(V), description: z, schema: O, uiSchema: a, registry: g }),
          rawDescription: W,
          help: J,
            ...
            i &&
              (0, n.jsx)("div", {
                ...
                children: (0, n.jsxs)("div", {
                  ...
                  children: [
                    (o || a) && (0, n.jsx)(x, { style: b, disabled: s || p || !o, onClick: m(d, d - 1), uiSchema: g, registry: f }),
      ...
      function rr(e) {
        ...
        return (0, n.jsx)(tr, { title: t(i.TranslatableString.CopyButton), className: "array-item-copy", ...e, icon: "copy" });
      }
      function nr(e) {
        const {
          registry: { translateString: t },
        } = e;
        return (0, n.jsx)(tr, { title: t(i.TranslatableString.MoveDownButton), className: "array-item-move-down", ...e, icon: "arrow-down" });
      }
      function sr(e) {
        const {
          registry: { translateString: t },
        } = e;
        return (0, n.jsx)(tr, { title: t(i.TranslatableString.MoveUpButton), className: "array-item-move-up", ...e, icon: "arrow-up" });
      }
      function ir(e) {
        const {
          registry: { translateString: t },
      ...
      function or() {
        return { SubmitButton: er, AddButton: ar, CopyButton: rr, MoveDownButton: nr, MoveUpButton: sr, RemoveButton: ir };
      }
      const lr = or;
      function cr(e) {
      ...
      function mr(e) {
        ...
        return (0, n.jsxs)(f, { ...e, children: [u && (0, n.jsx)(hr, { label: r, required: d, id: t }), u && l ? l : null, s, a, o] });
      }
      const pr = mr;
      function fr(e) {
      ...
      function xr(e) {
        ...
        return (0, n.jsxs)("legend", { id: t, children: [r, s && (0, n.jsx)("span", { className: "required", children: Sr })] });
      }
      function vr(e) {
      ...
      function Qr({ options: e, value: t, required: r, disabled: a, readonly: o, autofocus: l = false, onBlur: c, onFocus: d, onChange: u, id: h }) {
      ...
      const hn = un;
      function mn() {
        return { fields: Ht(), templates: Fr(), widgets: hn(), rootSchema: {}, formContext: {}, translateString: i.englishStringTranslator };
      }
