      ...
      class ye {
        ...
        code(e) {
          ...
          if (t) {
            ...
            return { type: "code", raw: t[0], codeBlockStyle: "indented", text: !this.options.pedantic ? xe(e, "\n") : e };
          }
        }
        fences(e) {
        ...
        html(e) {
          ...
          if (t) {
            const e = { type: "html", block: true, raw: t[0], pre: t[1] === "pre" || t[1] === "script" || t[1] === "style", text: t[0] };
            return e;
          }
        }
        def(e) {
          ...
          if (t) {
            ...
            const n = t[2] ? t[2].replace(this.rules.other.hrefBrackets, "$1").replace(this.rules.inline.anyPunctuation, "$1") : "";
        ...
        table(e) {
          ...
          for (const l of r) {
            i.rows.push(de(l, i.header.length).map((e, t) => ({ text: e, tokens: this.lexer.inline(e), header: false, align: i.align[t] })));
          }
          return i;
        }
        lheading(e) {
        ...
        tag(e) {
          ...
          if (t) {
            ...
            return { type: "html", raw: t[0], inLink: this.lexer.state.inLink, inRawBlock: this.lexer.state.inRawBlock, block: false, text: t[0] };
          }
        }
        link(e) {
            ...
            if (e.length > 0) {
              while ((s = this.tokenizer.rules.inline.reflinkSearch.exec(n)) != null) {
                if (e.includes(s[0].slice(s[0].lastIndexOf("[") + 1, -1))) {
                  n = n.slice(0, s.index) + "[" + "a".repeat(s[0].length - 2) + "]" + n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex);
                }
              }
            }
          }
        ...
        parse(e, t = true) {
          ...
          for (let s = 0; s < e.length; s++) {
            ...
            if (this.options.extensions?.renderers?.[r.type]) {
              ...
              if (t !== false || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(e.type)) {
                n += t || "";
                continue;
              }
            }
            ...
            switch (i.type) {
              ...
              case "text": {
                ...
                if (t) {
                  n += this.renderer.paragraph({ type: "paragraph", raw: l, text: l, tokens: [{ type: "text", raw: l, text: l, escaped: true }] });
                } else {
                  n += l;
                }
                continue;
        ...
        parseInline(e, t = this.renderer) {
          ...
          for (let s = 0; s < e.length; s++) {
            ...
            if (this.options.extensions?.renderers?.[r.type]) {
              ...
              if (e !== false || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(r.type)) {
                n += e || "";
                continue;
              }
            }
