...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [4353],
  {
    44353: (e, t, n) => {
      ...
      class Z {
        ...
        addChanges(e, t, n, o, l) {
          ...
          if (
            ...
            e.changes &&
            (!n || Y.test(n)) &&
            ((!i.selectionsAfter.length && t - this.prevTime < o.newGroupDelay && o.joinToEvent(l, W(i.changes, e.changes))) ||
            ...
            s = H(
              ...
              s.length - 1,
              o.minDepth,
              new P(e.changes.compose(i.changes), _(r.StateEffect.mapEffects(e.effects, i.changes), i.effects), i.mapped, i.startSelection, j)
            );
          } else {
        ...
        addSelection(e, t, n, r) {
          ...
          if (o.length > 0 && t - this.prevTime < r && n == this.prevUserEvent && n && /^select($|\.)/.test(n) && z(o[o.length - 1], e)) return this;
      ...
      const Ae = typeof Intl != "undefined" && Intl.Segmenter ? new Intl.Segmenter(undefined, { granularity: "word" }) : null;
      function Ce(e, t, n) {
      ...
      const Tt = ({ state: e, dispatch: t }) => {
        let n = te(e.selection, (t) => {
          ...
          for (let e = o; e; e = e.next) {
            let { node: n } = e;
            if (((n.from < t.from && n.to >= t.to) || (n.to > t.to && n.from <= t.from)) && e.next) return r.EditorSelection.range(n.to, n.from);
          }
          return t;
        });
        ...
        t(
          e.update(
            e.changeByRange((t) => {
              ...
              return { changes: { from: t.from, to: t.to, insert: e.lineBreak + n }, range: r.EditorSelection.cursor(t.from + n.length + 1) };
            }),
